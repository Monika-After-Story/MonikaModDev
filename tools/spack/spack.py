...
class SpackType(Enum):
    ACS = ("a", "acs", ACSFileConverter(), "ACS", 0)
    HAIR = ("h", "hair", HairFileConverter(), "Hair", 1)
    CLOTHES = ("c", None, None, "Clothes", 2)
    ...
    def __init__(
        ...
        self.json_type_value = json_type_value
