...
You can chat with the core team on [our development Discord channel](https://discord.gg/NYXWHaX). We're always friendly to new contributors, and it's not just a great place to get help, but also just a fun place to hang out with like-minded DDLC fans.
