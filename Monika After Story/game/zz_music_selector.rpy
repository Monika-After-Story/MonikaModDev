...
screen music_menu(music_page, page_num=0, more_pages=False):
    ...
    style_prefix ("music_menu" + mas_ui.ui_mode_suffix)

    frame:
        style ("music_menu" + mas_ui.ui_mode_suffix + "_outer_frame")

        hbox:

            frame:
                style ("music_menu" + mas_ui.ui_mode_suffix + "_navigation_frame")

            frame:
                style ("music_menu" + mas_ui.ui_mode_suffix + "_content_frame")
    ...
    vbox:
        ...
        hbox:
            ...
            if page_num > 0:
                textbutton _("<<<< Prev"):
                    style ("music_menu" + mas_ui.ui_mode_suffix + "_prev_button")
...
#                        sensitive False
            ...
            if more_pages:
                textbutton _("Next >>>>"):
                    style ("music_menu" + mas_ui.ui_mode_suffix + "_return_button")
                    action Return(page_num + 1)
