label import_ddlc_persistent:
    ...
    python:
        ...
        old_persistent_temp=loads(s)
        old_persistent=vars(old_persistent_temp)
    ...
    python:
        ...
        old_persistent['_seen_translates']
