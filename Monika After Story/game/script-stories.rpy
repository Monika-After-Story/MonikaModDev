...
label mas_story_mother_and_trees:
    ...
    m 1eua "While he was busy with his life, he still made time to keep in touch with her."
    ...
    m 2ekd "In her will, she only had one request of him...{w=0.3}and that was to keep taking care of the trees and talking to them every day."
    ...
    m 2dku "He always wanted to take his mother's wish very seriously, and it was then when he started talking to the trees every day, just as his mother wished."
    m 2duu "...And he even went ahead to plant one more tree."
    return
