...
init 5 python:
    addEvent(
        Event(
            persistent._mas_story_database,
            eventlabel="mas_story_living_puppet",
            prompt="The Living Puppet",
            category=[mas_stories.TYPE_NORMAL],
            unlocked=False
        ),
        code="STY"
...
label mas_story_living_puppet:
    ...
    m 1euc "She was brought back into her artificial world by her favorite puppet, who at that point, was indistinguishable from a real human, as a result of the girl's hard work."
    m 1eud "He cared for the girl as time went on, but couldn't wake her."
    m 1euc "Over time, he was filled with rage and grew to hate humanity."
    m 1efc "He blamed humanity for what they put him and the girl through, and wanted to flip their world upside down."
    m 3efd "And so, while he tended to the girl, he let her dark magic spread all throughout the real world."
    m 2ekc "Still, he was miserable living without her, and wanted to see her wake up more than anything."
    ...
    m 1hua "The magic was gone, and her world was slowly fading, but with a newfound strength, she went back out into the world with her puppet, and carried on living with it."
    m 1eua "I hope you liked that story, [player]."
    show monika 5hubfa at t11 zorder MAS_MONIKA_Z with dissolve
    m 5hubfa "If I had to, I would give myself for you~"
    return
