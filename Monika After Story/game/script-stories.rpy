...
label mas_story_mindthegap:
    ...
    m 2euc "But one thing,{w=0.2} for those five years, had helped her continue on."
    m 7fka "Every day, when she was on her way to work, she got to hear his voice at the station.{w=0.2} Sometimes she would linger and sit, just to hear him speak those short words."
    m 2ekc"But now..."
    ...
    m 3eua "And after the new year had passed, one day when Margaret was making her daily commute, a familiar voice rang out on the platform."
    ...
    m 1dkbltdb "I'll always treasure you, [player]."
    return
