...
label mas_story_genie_simple:
    ...
    m 3euc "He met a woman that challenged the way he saw the world."
    ...
    m 1eud "No one had ever turned a wish from the genie down before, which left him confused as to why."
    ...
    m 1hua "The genie began to feel a small sense of accomplishment, as he created something for the first time without willing into existence."
    ...
    m 3eua "There's a few things to take from the story."
...
label mas_story_genie_regret:
    ...
    m 1rkc "He knew some of them were caused by wishes he granted."
    m 1ekc "At first, he wasn't too concerned with the consequences...but after a while, it began to bother him more and more."
    m 1ekd "He had come to a simple, beautiful, pure world, and caused great, permanent damage to it."
    ...
    m 2ekc "He wanted things to return to how they always were, but his pleas always fell upon deaf ears."
    m 2eka "As time went on however, he had met some people and made friends who taught him how to go on despite all his acts."
    m "It was true that he was the one who granted the wishes that started the chaos...{w=0.5}{nw}"
    extend 2ekd "but something was bound to happen even without him."
    m 3ekd "There was bound to be jealousy and unfairness among people...{w=0.3}{nw}"
    extend 3eka "but in the end, the world was still doing alright."
    m 3eua "He was going to live with the things he had done in his life, but the question remained as to what he planned to do about it."
    ...
    m 1eka "The moral of the story is regret and how you shouldn't let it keep you down."
    m 3ekd "Mistakes will happen, people will get hurt.{w=0.5} Nothing will ever change that."
    m 3eka "Even if you've done something you regret, something was bound to happen eventually."
...
label mas_story_genie_end:
    ...
    m 1euc "He had seen everything there was to see...{w=0.3}lived freely, and learned the fulfillment of working for a goal."
    ...
    m 1rksdlc "There were still a very select few people whom he held dear, despite knowing that he would have to watch them die as well."
    ...
    m 1eua "He wished for his friend to get the peaceful rest he deserves."
    m 1lksdla "While it's true that his genie friend might not have been anyone particularly special..."
    m 3eua "He was definitely someone who deserved respect.{w=0.3} {nw}"
    extend 3eub "Especially after living such a long life."

    if mas_isMoniNormal(higher=True):
        m 3ekbsa "I don't care how many people think otherwise, but I think you're really special, [player]."
        m 3hubfb "And I think everyone should respect you for everything you've done!"
    return
