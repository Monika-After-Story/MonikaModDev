...
label mas_story_mindthegap:
    ...
    m 1tkc "Though, this explanation seemed not to calm her down. {w=0.3}'That voice,' she explained, 'was my husband.'"
    m 1dud "Her husband, Oswald Laurence, had been an actor who had never become famous, but had recorded all of the announcements for the northern line."
    m 2dkc "But Oswald had died five years ago."
    m 2ekc "They had loved each other dearly, and his death had left her in terrible grief. But one thing, for those five years, had helped her continue on."
    m 2fka "Every day, when she was on her way to work, she got to hear his voice at the station. Sometimes she would linger and sit, just to hear him speak those short words."
    m 2fkc"But now..."
    m 2dkd "The staff were apologetic, but didn't know if they had access to the old file. They told her that if they found it, they would contact her."
    m 2dkc "...{w0.3}But..."
    ...
    m 7ekb "So, even though it would take extra work to update the old recording from the archives to work with the current system, they got to work."
    m "And after the new year had passed, one day when Margaret was making her daily commute, a familiar voice rang out on the platform."
    ...
    m 3ekb "It's a really beautiful example of human kindness. The workers didn't stand to gain much by restoring a much shorter, lower quality recording."
    m 1fka "But they knew what it was like to lose someone, and how precious it makes every photo, every memory."
    m 1ektpa "It goes to show that people can do incredible things simply out of compassion and love."
    m 1dkbltpa "And this story reminds me to treasure every moment, and not to take any piece of our time together for granted."
    m 1dkbltpb "I'll always treasure you, [player]."
    return
