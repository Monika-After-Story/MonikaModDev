...
TimeCoord=rq.Struct(rq.Card32('time'),rq.Int16(_A),rq.Int16(_B))
Host=rq.Struct(rq.Set('family',1,(X.FamilyInternet,X.FamilyDECnet,X.FamilyChaos)),rq.Pad(1),rq.LengthOf(_C,2),rq.List(_C,rq.Card8Obj))
CharInfo=rq.Struct(rq.Int16('left_side_bearing'),rq.Int16('right_side_bearing'),rq.Int16('character_width'),rq.Int16('ascent'),rq.Int16('descent'),rq.Card16('attributes'))
FontProp=rq.Struct(rq.Card32(_C),rq.Card32('value'))
ColorItem=rq.Struct(rq.Card32('pixel'),rq.Card16(_D),rq.Card16(_E),rq.Card16(_F),rq.Card8('flags'),rq.Pad(1))
RGB=rq.Struct(rq.Card16(_D),rq.Card16(_E),rq.Card16(_F),rq.Pad(2))
Point=rq.Struct(rq.Int16(_A),rq.Int16(_B))
Segment=rq.Struct(rq.Int16('x1'),rq.Int16('y1'),rq.Int16('x2'),rq.Int16('y2'))
Rectangle=rq.Struct(rq.Int16(_A),rq.Int16(_B),rq.Card16(_G),rq.Card16(_H))
Arc=rq.Struct(rq.Int16(_A),rq.Int16(_B),rq.Card16(_G),rq.Card16(_H),rq.Int16('angle1'),rq.Int16('angle2'))
