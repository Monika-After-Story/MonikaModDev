...
TimeCoord=rq.Struct(rq.Card32('time'),rq.Int16(_B),rq.Int16(_A))
...
ColorItem=rq.Struct(rq.Card32('pixel'),rq.Card16(_H),rq.Card16(_F),rq.Card16(_G),rq.Card8('flags'),rq.Pad(1))
RGB=rq.Struct(rq.Card16(_H),rq.Card16(_F),rq.Card16(_G),rq.Pad(2))
Point=rq.Struct(rq.Int16(_B),rq.Int16(_A))
Segment=rq.Struct(rq.Int16('x1'),rq.Int16('y1'),rq.Int16('x2'),rq.Int16('y2'))
Rectangle=rq.Struct(rq.Int16(_B),rq.Int16(_A),rq.Card16(_E),rq.Card16(_D))
Arc=rq.Struct(rq.Int16(_B),rq.Int16(_A),rq.Card16(_E),rq.Card16(_D),rq.Int16('angle1'),rq.Int16('angle2'))