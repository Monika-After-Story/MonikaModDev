...
init 5 python:
    addEvent(
        Event(
            ...
            prompt=_("Can you teach me about grammar?"),
            pool=True,
...
init 5 python:
    addEvent(
        Event(
            ...
            category=["grammar tips"],
            prompt=_("Comma Splices and Run-ons"),
            pool=True,
...
init 5 python:
    addEvent(
        Event(
            ...
            category=["grammar tips"],
            prompt=_("Active and Passive Voices"),
            pool=True,
