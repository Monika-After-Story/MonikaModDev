...
label ch1_y_end:
    call showpoem(poem_y1, img="yuri 3t") from _call_showpoem_8
    y 3t "..."
...
label ch2_y_end:
    call showpoem(poem_y2) from _call_showpoem_9
    y 2m "Um..."
...
label ch3_y_end:
    ...
    call showpoem(poem_y3, img="yuri 2v") from _call_showpoem_10
    y "Um..."
...
label ch3_y_end_special:
    call showpoem(poem_y3b, img="yuri 4b") from _call_showpoem_11
...
label ch1_n_end:
    call showpoem(poem_n1, img="natsuki 2s") from _call_showpoem_12
    n 2q "Yeah..."
...
label ch2_n_end:
    call showpoem(poem_n2) from _call_showpoem_13
    n 2a "Not bad, right?"
...
label ch3_n_end:
    ...
    call showpoem(poem_n3) from _call_showpoem_14
    n 2a "Yeah..."
...
label ch3_n_end_special:
    call showpoem(poem_n3b) from _call_showpoem_15
    n 1q "..."
...
label ch1_s_end:
    call showpoem(poem_s1) from _call_showpoem_16
    mc "Sayori..."
...
label ch2_s_end:
    call showpoem(poem_s2) from _call_showpoem_17
    mc "Holy crap..."
...
label ch1_m_end:
    call showpoem(poem_m1) from _call_showpoem_18
label ch1_m_end2:
...
label ch2_m_end:
    call showpoem(poem_m2) from _call_showpoem_19
    mc "Hm..."
    ...
    return
label ch3_m_end:
    call showpoem(poem_m3) from _call_showpoem_20
    m 1a "You know..."
