...
# Monika
image monika 1 = ConditionSwitch('is_sitting and is_morning()',im.Scale("mod_assets/monika/1.png",1600,927),'is_sitting and not is_morning()',im.Scale("mod_assets/monika/1-night.png",1600,927),'not is_sitting',im.Composite((960, 960), (0, 0), "monika/1l.png", (0, 0), "monika/1r.png", (0, 0), "monika/a.png"))
