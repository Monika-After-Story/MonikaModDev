...
label mas_song_yozurina:
    ...
    m 2rksdld "{i}~In a world scattered with bombs~{/i}"
    m 1hub "{i}~I was thinking about you, all this time~{/i}"
    ...
    m 4sub "{i}~Did you listen to this song yet?~{/i}"
    m 2hub "{i}~Fooling around, on the other sides of the screen~{/i}"
