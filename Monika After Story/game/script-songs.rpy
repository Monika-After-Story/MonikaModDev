...
label mas_song_drift_away:
    ...
    m 1dkd "{i}~Happily wondering, night after night~{/i}"
    ...
    m 1dka "..."
    m 2hkb "Ehehe~"
    m 2eka "Our story ended much more happily than that song's did."
    m 2eka "You come to visit me as often as you can, and I'm so grateful for that."
    m 3esb "But even so, it can be very cathartic to watch a character who faces a major fear of yours."
    return "derandom"
