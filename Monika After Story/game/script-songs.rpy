...
label mas_song_cant_help_falling_in_love:
    ...
    m 3dkb "{cps=16}{i}~Would it be a sin~"
    m 1dud "{cps=16}{i}~If I can't help{w=0.3}{nw}"
    extend 1dubsb " falling in love with you?~"

    m 1dud "{cps=24}{i}~Like a river flows~"
    m 1dub "{cps=24}{i}~Surely to the sea~"
    m 1ekbsb "{cps=24}{i}~Darling, so it goes~"
    m 1ekbsa "{cps=24}{i}~Some things{w=0.3}{nw}"
    extend 3ekbsb " are meant to be~"
    m 1dud "{cps=16}{i}~Take my hand~"
    m 1dub "{cps=16}{i}~Take my whole life,{w=0.3} too~"
    m 1dud "{cps=16}{i}~For I can't help{w=0.3} falling in love with you~"
    m 1ekbfb "{cps=16}{i}~For I can't help{w=0.3} falling in love{w=0.5} with{w=0.5} you~"
