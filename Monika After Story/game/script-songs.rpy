...
label mas_song_abstract_nonsense:
    m 2dfd "{i}~This is useless,{/i}{w=0.5}"
    extend 2rkd "{i} I want it to stop,{/i}{w=0.5}"
    extend 6rkc "{i} I put my face out the window~{/i}"
    m 2dfd "{i}~This is boring,{/i}{w=0.5}"
    extend 2rkd "{i} I'm tired of it,{/i}{w=0.5}"
    extend 6rkc "{i} but I don't have the courage to die~{/i}"
    m 2dfd "{i}~This is useless,{/i}{w=0.5}"
    extend 2rkd "{i} I want it to stop,{/i}{w=0.5}{nw}"
    extend 5rkc "{i} I'm injecting my wrist~{/i}"
    m 2dfd "{i}~This is boring,{/i}{w=0.5}"
    extend 2rkd "{i} I'm tired of it,{/i}{w=0.5}"
    extend 1tsc "{i} I eat the cake{/i}{w=0.5}"
    extend 6dsd "{i} and take a deep breath~{/i}"
