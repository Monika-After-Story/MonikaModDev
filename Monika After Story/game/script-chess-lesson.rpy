...
label monika_chesslesson_opening_basic_idea:
    ...
    m 2esa "Talking about {i}materials{/i} the word, it means the power of pieces."
    m 2eub "So {i}develop materials{/i} the term basically stands for move your pieces to a good position that can make the most of them."
