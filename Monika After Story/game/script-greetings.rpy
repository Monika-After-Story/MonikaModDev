...
#Custom greetings made by monikLover 10/27/17
label greeting_konichiwa:
    m "Konichiwa, [player]-kun!"
    m "Ahaha!"
    m "I learned that from one of Natsuki's manga in her collection."
    m "I was wondering when you'd be back~"
    return
    
label greeting_german:
    m "Guten tag, [player]!"
    m "I said that right, right?"
    m "I just thought it'd be nice to know different languages from your reality."
    m "That way, we can understand each other in more ways than English! Ehehe~"
    return
    
label greeting_newlywed:
    m "Welcome home, [player]!"
    m "Would you like your meal ready? Or maybe your bath?"
    m "Or maybe you would like..."
    m "...Ahaha! Just kidding."
    m "I heard newlywed housewives take extra care of their husbands when they return home."
    m "Maybe once we share realities, I'll start taking extra care of you~"
    return
...
label greeting_miss:
    ...
    menu:
        m "Did you miss me?"
        "Yes.":
            m "Aww, I missed you too!"
            m "I can't help but feel loved when I'm always in your thoughts when you're gone."
            m "There will be a day when we can always be together, side by side..."
            m "Till then, let's spend quality time together, [player]~"
        "No.":
            m "Ah, I see..."
            m "You must have my character file with you all the time, huh?"
            m "Knowing that you always have me with you when you're out makes me so happy!"
            m "You're such a sweet boyfriend, [player]!"
    return
#End of custom greetings