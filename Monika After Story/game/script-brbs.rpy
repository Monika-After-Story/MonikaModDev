...
label monika_idle_nap:
    if mas_isMoniNormal(higher=True):
        m 1eua "Going to take a nap?"
        m 3eub "It's healthy to take naps during the day if you need a bit of a rest."
        m 3hua "I'll watch over you-{w=0.2} don't worry~"
        m 1hub "Sweet dreams!"
    elif mas_isMoniUpset():
        m 2eud "Alright, I hope you feel better rested afterwards."
...
label monika_idle_nap_callback:
    if mas_isMoniNormal(higher=True):
        ...
        if mas_brbs.was_idle_for_at_least(datetime.timedelta(hours=5), "monika_idle_nap"):
            ...
            m 3rksdlb "When you said you were going to take a nap, I was expecting you take maybe an hour or two..."
            m 1hksdlb "I guess you must have been really tired, ahaha..."
            m 3eua "But after sleeping for that long, that means you'll be here with me for a long time, right?"
            m 1hua "Ehehe~"
        elif mas_brbs.was_idle_for_at_least(datetime.timedelta(hours=1), "monika_idle_nap"):
            m 1eub "Welcome back, [player]!"
            m 1eua "Did you have a nice nap?"
            m 3eub "Naps are really helpful for refreshing your mind so you can spend the day with a clear state of mind."
            m 3rksdla "But if you nap for too long, it can take a while to fully wake up again, just like getting out of bed in the morning."
            ...
            m 3eua "Short naps throughout the day are perfect for quickly refreshing your brain and getting back to work with a fresh mind."
