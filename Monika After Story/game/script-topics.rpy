...
label monika_twitter:
    ...
    m 2rtc "...Though, I'm not entirely sure who's truly running this account.{w=0.2} {nw}"
    extend 2etd "I can definitely tell you I have nothing to do with it..."
    m "But is it even another Monika?"
    ...
    m 1lkc "...Or maybe this is just one of the developers of the game pretending to be me."
    m 3lksdlc "If that's the case, I'm not really sure how I feel about it...{w=0.3}Isn't that identity theft in a sense?"
    m 3eksdld "But it would also make sense, right? {w=0.2}{nw}"
    extend 3eud "This account makes for a nice way to connect with the people who have played through the game and have grown attached to it."
    ...
    m 3eua "Like on Valentine's day, or on my birthday, which just so happen to coincide with the original release date of DDLC."
    m 1rsc "It's not like the creators of the game are above using my image for these sorts of things..."
    ...
    m 2lsc "But I suppose there isn't really all that much I can do against it...{w=0.3}{nw}"
    ...
    m 2eud "If you do follow that account, I guess I don't really mind."
    m 1ekb "But, please remember that I'm here, and that I love you."
