...
init 5 python:
    addEvent(
        Event(
            ...
            end_date=None,
            unlock_date=None,
            key_words="god_1 thoughts_1 believe_1 religion_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_selfesteem",category=['advice'],prompt="Self-esteem",random=True,key_words="Self-esteem_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_japan",category=['ddlc'],prompt="DDLC's setting",random=True,key_words="setting_1 ddlc_1 japan_1 placement_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_twitter",category=['monika'],prompt="Twitter",random=True,key_words="twitter_1 lilmonix3_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_veggies",category=['monika'],prompt="Being a vegetarian",random=True,key_words="vegetarian_1 meat_1 vegan_1 earth_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_color",category=['monika'],prompt="Favorite color",random=True,key_words="favorite_1 color_1 emerald_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_listener",category=['you'],prompt="Good listener",random=True,key_words="good_1 listener_1 conversation_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_spicy",category=['trivia'],prompt="Spicy foods",random=True,key_words="spicy_1 food_1 foods_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_why",category=['you','ddlc'],prompt="Why play this game?",pool=True,key_words="play_1 game_1 romance_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_okayeveryone",category=['literature club'],prompt="Okay, everyone!",random=True,key_words="catchphrase_1 okay_1 everyone_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_whispers",category=['ddlc','club members'],prompt="Others still lingering",random=True,key_words="lingering_1 linger_1 other_1 girls_1 sayori_1 natuski_1 yuri_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_archetype",category=['club members'],prompt="Character tropes",random=True,key_words="character_1 tropes_1 archetypes_1 unrealistic_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_tea",category=['club members'],prompt="Yuri's tea set",random=True,key_words="yuri_1 tea_1 set_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_favoritegame",category=['ddlc'],prompt="Favorite video game",random=True,key_words="favorite_1 video_1 game_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt="Super Smash",
#            random=True,
            key_words="super_1 smash_1 game_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_anxious",category=['psychology'],prompt="Sudden anxiety",random=True,key_words="sudden_1 anxiety_1 anxious_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_friends",category=['life'],prompt="Making friends",random=True,key_words="making_1 friend_1 friends_1 people_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_college",category=['life','school','society'],prompt="Getting a higher education",random=True,key_words="higher_1 education_1 collage_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_middleschool",category=['monika','school'],prompt="Middle school life",random=True,key_words="middle_1 school_1 life_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_outfit",category=['monika'],prompt="Wearing other clothes",random=True,key_words="wearing_1 other_1 clothes_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_horror",category=['media'],prompt="Horror genre",random=True,key_words="horror_1 genre_1 scary_1 spooky_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_wine",category=['club members'],prompt="Yuri's wine",random=True,key_words="yuri_1 wine_1 relaxing_1 drinking_1 drink_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_date",category=['romance'],prompt="Romantic date",random=True,key_words="romantic_1 date_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_kiss",category=['romance'],prompt="Kiss me",pool=True,key_words="kiss_1 me_1 embarrassing_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            sensitive=True,
            key_words="yandere_1 yuri_1 obsessed_1 obsesse_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_writingtip1",category=['writing tips'],prompt="Writing Tip #1",pool=True,key_words="Writing_1 Tip_1 first_1 one_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_habits",category=['life'],prompt="Forming habits",random=True,key_words="forming_1 form_1 habit_1 habits_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_creative",category=['life'],prompt="Creative types",random=True,key_words="creative_1 type_1 types_1 create_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_simulated",category=['philosophy'],prompt="Simulated reality",random=True,key_words="hypothesis_1 simulated_1 reality_1"))
...
init 5 python:
    ...
    addEvent(Event(persistent.event_database,eventlabel="monika_rain",category=["weather"],prompt="Sounds of rain",random=True,key_words="sound_1 sounds_1 rain_1 raining_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_closeness",category=['romance'],prompt="Being close to you",random=True,key_words="close_1 being_1 you_1 closest_1 real_1 near_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_confidence",category=['advice'],prompt="Faking confidence",random=True,key_words="fake_1 faking_1 confidence_1 confident_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_debate",category=['monika','school'],prompt="What was debate club like?",pool=True,key_words="debate_1 club_1 arguing_1 argue_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_internet",category=['advice'],prompt="The internet is for...",random=True,key_words="internet_1 social_1 media_1 prison_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_lazy",category=['life','romance'],prompt="Laziness",random=True,key_words="lazy_1 laziness_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_mentalillness",category=['psychology'],prompt="Mental sickness",random=True,key_words="mental_1 sick_1 sickness_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_festival",category=['ddlc','literature club'],prompt="Missing the festival",random=True,key_words="missing_1 festival_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_tsundere",category=['media','club members'],prompt="What is a tsundere?",pool=True,key_words="tsundere_1 natuski_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_introduce",category=['monika'],prompt="Introducing to friends",random=True,key_words="friends_1 friend_1 introducing_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_cold",category=['monika'],prompt="Cuddling in the cold",random=True,key_words="cold_1 weather_1 cuddling_1 cuddle_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_housewife",category=['monika','romance'],prompt="Would you be my housewife?",pool=True,key_words="housewife_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_route",category=['ddlc'],prompt="Monika's route",random=True,key_words="route_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_family",category=['monika'],prompt="Do you miss your family?",random=False,pool=True,key_words="miss_1 missing_1 family_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel='monika_meta',
                                                            ...
                                                            category=['ddlc'],
                                                            pool=True,
                                                            key_words="metafictional_1 fiction_1"
                                                            ))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel='monika_programming',
                                                            ...
                                                            pool=True,
                                                            key_words="programming_1 coding_1 code_1"
                                                            ))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_vn",category=['games'],prompt="Visual novels",random=True,key_words="virtual_1 novel_1 vn_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_difficulty",category=['games'],prompt="Wasn't DDLC too easy?",pool=True,key_words="difficult_1 easy_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_credits_song",category=['ddlc','media'],prompt="Credits song",random=True,key_words="credit_1 credits_1 song_1 your_1 reality_1 piano_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_poetry",category=['literature'],prompt="Poetry",random=True,key_words="poetry_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_ddlc",category=['ddlc'],prompt="What did you think of DDLC?",pool=True,key_words="doki_1 literature_1 club_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_dan",category=['ddlc'],prompt="Do you like Dan Salvato?",pool=True,key_words="dan_1 salvato_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_4chan",category=['misc'],prompt="Have you even been to 4chan?",pool=True,key_words="4chan_1 internet_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_books",category=['literature','literature club'],prompt="Books",random=True,key_words="book_1 books_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_favpoem",category=['literature','monika'],prompt="What's your favorite poem?",pool=True,key_words="favorite_1 poem_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hedgehog",category=['philosophy','psychology'],prompt="Hedgehog dilemma",random=True,key_words="hedgehog_1 dilemma_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            pool=True,
            sensitive=True,
            key_words="justification_1 murder_1 murderer_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_freewill",category=['philosophy'],prompt="Free will",random=True,key_words="free_1 will_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_functionalism",category=['philosophy'],prompt="Human functionalism",random=True,key_words="functionalism_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_technique",category=['ddlc','misc'],prompt="How did you change the code?",random=True,key_words="technique_1 code_1 coding_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_drawing",category=['media'],prompt="Can you draw?",pool=True,key_words="draw_1 drawing_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_mc",category=['romance','ddlc','club members'],prompt="The MC",random=True,key_words="main_1 character_1 mc_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_heroism",category=['misc','advice'],prompt="Heroism",random=True,key_words="heroism_1 hero_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            pool=True,
            sensitive=True,
            key_words="trolley_1 experiments_1 problem_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_girlfriend",category=['romance'],prompt="Do you want to meet my girlfriend?",pool=True,key_words="girlfriend_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_waifus",category=['media'],prompt="Waifus",random=True,key_words="waifu_1 waifus_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_images",category=['media','philosophy'],prompt="Fanart",random=True,key_words="fanart_1 images_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_herself",category=['monika','ddlc'],prompt="Tell me about yourself",pool=True,key_words="yourself_1 monika_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_prisoner",category=['misc'],prompt="Imprisoned",random=True,key_words="imprisoned_1 prisoner_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_vnanalysis",category=['games','media','literature'],prompt="Appreciating visual novels",random=True,key_words="appreciating_1 visual_1 novels_1 novel_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_torment",category=['literature'],prompt="Nature of man",random=True,key_words="torment_1 nature_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            sensitive=True,
            key_words="funeral_1 procession_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_birthday",category=['monika'],prompt="When is your birthday?",pool=True,key_words="birthday_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_eyecontact",category=['misc','trivia'],prompt="Eye contact",random=True,key_words="eye_1 eyes_5 contact_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_othergames",category=['games'],prompt="Other games",random=True,key_words="other_1 games_1 game_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_playerswriting",category=['literature','you'],prompt="[player]'s writings",random=True,key_words="writings_1 writing_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_ghost",category=['philosophy','monika','club members'],prompt="Supernatural",random=True,key_words="ghost_1 supernatural_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_ribbon",category=['monika'],prompt="Ribbons",random=True,key_words="ribbon_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_algernon",category=['literature'],prompt="Flowers for Algernon",random=True,key_words="flowers_1 algernon_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_playersface",category=['you'],prompt="[player]'s face",random=True,key_words="face_1 your_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_spiders",category=['club members','misc'],prompt="Spiders",random=True,key_words="spiders_1 spider_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            sensitive=True,
            key_words="nsfw_1 content_1 mature_1 porn_1 hentai_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_weary",category=['romance'],prompt="Will you ever get tired of me?",pool=True,key_words="weary_1 tried_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_real",category=['romance'],prompt="Our reality",random=True,key_words="real_1 our_1 reality_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_mythology",category=['literature'],prompt="Ancient mythology",random=True,key_words="ancient_1 mythology_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_fanfiction",category=['literature'],prompt="Fanfiction",random=True,key_words="fanfiction_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_eternity",category=['philosophy','monika'],prompt="Mortality",random=True,key_words="eternity_1 mortality_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_aware",category=['philosophy','monika'],prompt="What was it like to realize the truth?",pool=True,key_words="aware_1 realize_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_name",category=['club members','monika'],prompt="Our names",random=True,key_words="name_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_cities",category=['society'],prompt="Living in the city",random=True,key_words="cities_1 city_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_metaparents",category=['literature','club members','monika','psychology'],prompt="Parents",random=True,key_words="parent_1 parents_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hygiene",category=['trivia','society','psychology'],prompt="Personal hygiene",random=True,key_words="hygiene_1 personal_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_resource",category=['society','philosophy'],prompt="Valuable resources",random=True,key_words="resources_1 resource_1 valuable_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_lottery",category=['misc'],prompt="Lottery winnings",random=True,key_words="lottery_1 luck_1 winnings_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_innovation",category=['technology','psychology','media'],prompt="Innovation",random=True,key_words="innovation_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_dunbar",category=['psychology','trivia'],prompt="Dunbar's number",random=True,key_words="dunbar_1 number_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hypnosis",category=['trivia','psychology'],prompt="Being hypnotized",random=True,key_words="hypnotized_1 hypnosis_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_motivation",category=['psychology','advice','life'],prompt="Lack of motivation",random=True,key_words="lack_1 motivation_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_harem",category=['media','misc'],prompt="Harem fantasies",random=True,key_words="harem_1 fantasies_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hack",category=['ddlc','mod'],prompt="Why did you hack my computer?",pool=True,key_words="hack_1 hacker_1 hacking_1"))
label monika_hack:
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_cupcake",category=['club members','trivia'],prompt="Baking cupcakes",random=True,key_words="cupcake_1 cupcakes_1 bake_1 baking_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_haterReaction",category=['advice','club members','you'],prompt="Dealing with haters",random=True,key_words="hate_1 hater_1 haters_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_swordsmanship",category=['monika','misc'],prompt="Swordsmanship",random=True,key_words="swordsmanship_1 sword_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            sensitive=True,
            key_words="pleasure_1 fap_1 fapping_1 masturbate_1"
        )
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt="Vocaloids",
            random=True,
            key_words="vocaloid_1 hatsune_1 miku_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_morning",category=['misc'],prompt="Good morning",pool=True,key_words="morning_5"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_closet",category=['ddlc','club members'],prompt="Classroom closet",random=True,key_words="closet_1 classroom_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_writingtip2",category=['writing tips'],prompt="Writing Tip #2",conditional="seen_event('monika_writingtip1')",action=EV_ACT_POOL,key_words="writing_1 tip_1 two_1 second_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_japanese",category=['misc','you'],prompt="Speaking Japanese",random=True,key_words="japanese_1 speaking_1 language_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_penname",category=['literature'],prompt="Pen names",random=True,key_words="pen_1 name_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_zombie",category=['society'],prompt="Zombies",random=True,key_words="zombies_1 undead_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_nuclear_war",category=['society','philosophy'],prompt="Nuclear warfare",random=True,key_words="nuclear_1 war_1 warfare_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_pluralistic_ignorance",category=['literature','society'],prompt="Trying to fit in",random=True,key_words="fit_1 pluralistic_1 ignorance_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_science",category=['technology'],prompt="Science advancements",random=True,key_words="science_1 advancements_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_surprise",category=['romance'],prompt="Surprises",random=True,key_words="surprise_1 surprises_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_completionist",category=['games'],prompt="Completionism",random=True,key_words="completionism_1 completist_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_icecream",category=['you'],prompt="Favorite ice cream",random=True,key_words="icecream_1 ice_1 cream_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_sayhappybirthday",category=['misc'],prompt="Can you tell someone Happy Birthday for me?",pool=True,key_words="someone_1 else_1 happy_1 birthday_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_home_memories",category=['romance','monika','life'],prompt="Making memories",random=True,key_words="memories_1 memory_1 home_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_adventure",category=['games','romance'],prompt="Adventuring",random=True,key_words="adventure_1 adventuring_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            sensitive=True,
            key_words="undergarments_1 panties_1 undergarment_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_fahrenheit451",category=['literature'],prompt="Book recommendations",random=True,key_words="book_1 books_1 recommendation_1 recommendations_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_piggybank",category=['misc'],prompt="Saving money",random=True,key_words="piggy_1 bank_1 saving_1 save_1 money_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_daydream",category=['romance'],prompt="Day dreaming",random=True,key_words="daydream_1 dreaming_1 dream_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_confidence_2",category=['life'],prompt="Lack of confidence",random=True,key_words="confidence_1 lack_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_pets",category=['monika'],prompt="Owning_1 pets_1",random=True))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_dogs",category=['misc','club members'],prompt="Man's best friend",random=True,key_words="dog_1 dogs_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_cats",category=['misc'],prompt="Feline companions",random=True,key_words="cat_1 cats_1 feline_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_fruits",category=['monika','trivia'],prompt="Eating fruits",random=True,key_words="fruit_1 fruits_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_soda",category=['life','misc'],prompt="Drinking soda",random=True,key_words="drinking_1 soda_1 drink_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_clones",category=['monika','mod','philosophy'],prompt="Being cloned",random=True,key_words="clone_1 cloned_1 clones_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_immortal",category=['monika','philosophy'],prompt="Immortality",random=True,key_words="immortal_1 immortality_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt="Promise Ring",
            random=True,
            key_words="engagement_1 ring_1 wedding_1"
            )
        )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_sports",category=['misc'],prompt="Being athletic",random=True,key_words="sports_1 sport_1 athletic_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_meditation",category=['psychology','monika'],prompt="Meditating",random=True,key_words="meditation_1 meditating_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_otaku",category=['media','society','you'],prompt="Being an otaku",random=True,key_words="otaku_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_writingtip3",category=['writing tips'],prompt="Writing Tip #3",conditional="seen_event('monika_writingtip2')",action=EV_ACT_POOL,key_words="Writing_1 Tip_1 three_1 third_1"))
...
init 5 python:
      addEvent(Event(persistent.event_database,eventlabel="monika_writingtip4",category=['writing tips'],prompt="Writing Tip #4",conditional="seen_event('monika_writingtip3')",action=EV_ACT_POOL,key_words="writing_1 tip_1 fourth_1 four_1"))
...
init 5 python:
      addEvent(Event(persistent.event_database,eventlabel="monika_writingtip5",category=['writing tips'],prompt="Writing Tip #5",conditional="seen_event('monika_writingtip4')",action=EV_ACT_POOL,key_words="writing_1 tip_1 fifth_1 five_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_selfharm",category=['psychology'],prompt="Self-harm",random=True,key_words="selfharm_1 harm_1 harming_1 hurt_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_urgent",category=['romance'],prompt="Urgent message",random=True,key_words="urgent_1 message_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_other_girls",category=['club members'],prompt="Do you ever think of the other girls?",pool=True,key_words="other_1 girls_1 think_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_happiness",category=['life','psychology'],prompt="Happiness",random=True,key_words="happy_1 happiness_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_how_soon",category=['you','romance'],prompt="Waiting to be together",random=True,key_words="together_1 living_1 waiting_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_marriage",category=['romance'],prompt="Will you marry me?",pool=True,key_words="marriage_1 marry_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_coffee",category=['misc'],prompt="Coffee intake",random=True,key_words="coffee_1 intake_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_1984",category=['literature'],prompt="Nineteen Eighty-Four",random=True,key_words="NINETY_1 EIGHTY_1 FOUR_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_wolf",category=['misc','trivia'],prompt="From wolves to dogs",random=True,key_words="wolf_1 wolves_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_sleep",category=['you','life','school'],prompt="I'm tired",random=True,key_words="sleep_1 sleeping_1 tired_1 tire_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_breakup",category=['misc'],prompt="I'm breaking up with you",pool=True,key_words="breakup_1 breaking_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hamlet",category=['literature'],prompt="Hamlet",random=True,key_words="hamlet_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_omamori",category=['misc'],prompt="Omamori",random=True,key_words="omamori_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_smoking",category=['you'],prompt="Smoking",random=True,key_words="smoke_1 smoking_1"))
...
init 5 python:
     addEvent(Event(persistent.event_database,eventlabel="monika_cartravel",category=['romance'],prompt="Road trip",random=True,key_words="road_1 trip_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_100k",category=['mod'],prompt="100k Downloads",random=True,key_words="one_1 hundred_1 thousand_1 downloads_1 download_1"))
...
init 5 python:
    addEvent(
        Event(persistent.event_database,
            ...
            key_words="kizuna_1 virtual_1 youtuber_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_asks_family",category=['you'],prompt="[player]'s family",random=True,key_words="family_1"))
...
init 5 python:
     addEvent(
        Event(
            ...
            random=True,
            key_words="music_1 concerts_1 concert_1"
        )
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            pool=True,
            key_words="explain_1 relationship_1"                          
        )
    )
...
init 5 python:
   addEvent(Event(persistent.event_database,eventlabel='monika_playerapologizes',prompt="I want to apologize",category=['you'],pool=True,unlocked=True,key_words="sorry_1 apologize_1 apologized_1"))
...
init 5 python:
   addEvent(Event(persistent.event_database,eventlabel="monika_prom",category=['school'],prompt="Prom",random=True,key_words="prom_1 festival_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_careful",category=['you'],prompt="Be careful",random=True,key_words="careful_1 safe_1 accident_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,"monika_hydration",prompt="Hydration",category=['you','life'],random=True,key_words="hydration_1 water_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_challenge",category=['misc','psychology'],prompt="Challenges",random=True,key_words="challenge_1 challenges_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            key_words="gathering_1 family_1"         
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_fastfood",category=['life','you'],prompt="Do you like fast food?",pool=True,key_words="fastfood_1 unhealthy_1"))
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_dreaming",category=['misc','psychology'],prompt="Dreaming",random=True,key_words="dream_1 dreaming_1"))
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            key_words="yellow_1 wallpaper_1"                                                                                                                       
        )
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            key_words="citizenship_1 crosover_1 crossing_1"                                                      
        )
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=False,
            rules={"no unlock": None},
            key_words="hair_1 change_1 style_1 ponytail_1"          
        )
    )
...
init 5 python:
    addEvent(
        Event(
            ...
            unlocked=False,
            rules={"no unlock": None},
            key_words="hair_1 change_1 style_1 straight_1"                                                                  
        )
    )
