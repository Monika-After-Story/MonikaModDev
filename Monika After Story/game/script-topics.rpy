...
label monika_blood_type_stereotype:
    ...
    m "It's like the astrological signs in Occident."
    m 1eua "In fact, this belief is so popular that you've probably heard about it."
    m 2hub "After all, most visual novels tell you the blood type of their characters."
    m 4eub "It's a detail that can help players apprehend the character's personality."
    ...
    m 3eub "Next, there is the B group."
    ...
    m 1lud "It does not fit perfectly, but some of the traits are shared by Sayori."
    m 1eka "She really liked take care of other people, especially you."
    m 4eud "Back in the days before you even came to the club, when a fight would broke out, she'd instantly know the right words to calm everyone."
    ...
    if persistent._mas_pm_cares_about_dokis:
        ...
        m 2tkc "I almost feel sorry for the MC, having to put up with someone that unreliable."
        m 3efd "Even if she had her reasons, she never tried to change it to make things better. A lot of people ended up suffering unnecessarily because of that."
    ...
    m 1lssdrc "..."
    m 1lssdrb "Well, who cares about that anyway? Like I said, it has no scientific basis."
    m 3hksdrb "Plus, even in visual novels, people are never so unidimensional."
    m 1eka "I just thought that it was a funny thing to think about."
