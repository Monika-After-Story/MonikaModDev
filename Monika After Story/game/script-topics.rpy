...
label monika_renewable_energy:
    ...
    m 2etd "So why not use renewable energy instead?"
    ...
    m 2esc "Solar and wind can be effective, but they're heavily dependent on optimal weather."
    ...
    m 3eua "Dams are regulated better, wind turbines are quieter, and the efficiency of solar panels has skyrocketed."
    ...
    m 2eub "Sure, renewable energy still has a ways to go, but it's far better now than it was thirty years ago." 
