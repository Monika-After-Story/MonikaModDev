...
label monika_attractiveness:
    ...
    if mas_isMoniNormal(higher=True):
        ...
        if mas_isMoniEnamored(higher=True):
            ...
            m 4eub "It simply feels satisfying to keep good habits like that, and besides, who knows, maybe I'll be able to cross over into your reality and have a normal body like you."
            m 1hua "It won't hurt to make sure I'll be ready for that transition if it ever happens."
