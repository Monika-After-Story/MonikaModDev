...
label monika_curse_words:
    ...
    m 3esc "I know some people have it a natural part of their speech patterns, {w=0.2}and I totally understand that."
    m 1eud "This sort of words makes a talk a lot more casual and helps spicing up certain expressions... {w=0.5}{nw}"
    extend 3rksdla "Well, if still only used moderately, {w=0.2}I'd say."
    m 2eud "And I think it's totally fine to swear in your friends company, or any other informal surroundings."
    m 7eud "But don't get me wrong, {w=0.2}{nw}"
    extend 2dsd "I personally wouldn't like if you were constantly spitting them, [player]."
    m 1eua "If you ask me, {w=0.2}I'd say I don't curse at all, {w=0.2}even with my friends back when I had a chance to do so."
    ...
    m 1eka "You don't have to sound poetic talking about something you feel angry because of at all, {w=0.5}{nw}"
    extend 1hksdlb "of course not."
    m 1eua "I'm just trying to say that I really like when people keep the language clean."
    m 2eub "So, {w=0.2}[mas_get_player_nickname()], {w=0.2}if you don't mind, {w=0.2}I'd really like to see you using as less of this language as you can, {w=0.2}okay?"
    m 2tka "Could you do that... {w=0.5}{nw}"
    extend 2tkbsa "for me?~"
    m 2hub "I'd be so happy if you did, ehehe."
