...
label monika_gmos:
    ...
    m 1euc "That there's a lot of nuance to GMOs, but I'll do my best to summarize it."
    m 1euc "Scientists create GMOs by identifying a desirable gene from one organism, copying it, and inserting the copied gene into another organism."
    m 1euc "It's important to note here that the addition of the copied gene does {i}not{/i} change other existing genes."
    m 1euc "Think of it like flipping through a long book and changing a single word; the word is different, but the rest of the book stays the same."
    m 1euc "GMOs can be plants, animals, microorganisms, and more, but we'll focus on genetically modified plants."
    m 1euc "Plants can be modified in a myriad of ways, from resisting pests and herbicides to having a higher nutrition value and longer shelf life."
    m 1euc "This is huge. Imagine crops that can produce double their normal yield, tolerate climate change, and fend off drug-resistant superbugs. So many problems could be solved!"
    m 1euc "Unfortunately, it's not that simple. GMOs require several years of research, development, and testing before they can be distributed. On top of this, they come with several concerns."
    m 1euc "Are GMOs safe? Will they spread to other organisms and threaten biodiversity; if so, how can we prevent it? Who owns GMOs? Are GMOs responsible for increased herbicide usage?"   
    m 1euc "You can see how this begins to escalate, ahaha..."
    m 1euc "For now, let's cover the main issue...are GMOs safe?"
    m 1euc "The short answer is that we don't know for sure. Decades of research have indicated that GMOs are {i}probably{/i} harmless, but we have next to no data on their long-term effects."
    m 1euc "Additionally, each type of GMO needs to be carefully reviewed on a case-by-case, modification-by-modification basis to ensure its quality and safety."
    m 1euc "There are other considerations as well. Products containing GMOs have to be labelled, environmental effects must be considered, and misinformation has to be combated."
    m 1euc "..."
    m 1euc "Personally, I think that GMOs have a lot of potential to do good, but only if they continue to be heavily researched and tested."
    m 1euc "Major issues such as herbicide usage and gene flow {i}need{/i} to be fixed...biodiveristy is already at risk from climate change and deforestation."
    m 1euc "As long as we're careful, GMOs will be fine; it's recklessness and carelessness that pose the biggest threat."
    m 1euc "So what do you think, [player]? Quite the {i}promising field{/i}, wouldn't you say? Ehehe~"
    m 1euc "Like I said before, GMOs are a complex topic. If you want to learn more, make sure that your sources are reliable and that you're able to see the discussion from both sides."
    m 1euc "That's all I have to say. Thanks for listening~"
    return