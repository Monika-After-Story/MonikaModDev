...
label monika_gender_preferences_f:
    ...
    m "When you added this mod, you did tell me that you're a girl after all, assuming you were being serious, of course!"
    ...
    if mcname.lower() == player.lower():
        ...
        m 3b "Anyways, back to the differences... you two had different names and totally different mannerisms too!"
    m "And let's not even mention the fact that you're miles away from the type of person that he was... denser than a brick, and about as sensitive."
    m 3j "You're sensitive, and unbelievably sweet. So I knew you were a good person."
    m 3k "I hope you know, [player], that I love you just the way you are, whether the game was reflective of that person, or not! "
    ...
    menu:
        "What do you want to ask me?":
            ...
            m 1p "Wait, I mean…"
            m "I’m sorry! I’m not trying to force you into answering a personal question out of the blue like that!"
            ...
            m "But when you told me that you were also female, I wanted to make sure I wasn’t incorrectly assuming something about you."
            m 3i "And you did install this mod in the end, after all."
            m "I just thought. .. well, you don’t have to answer if you don’t want to. I was simply curious. It’s something I should know, right?"
    ...
    menu:
            "I'm into girls.":
                ...
                m "And you should never want to change those things about yourself, [player]."
...
label monika_gender_preferences_m:
    ...
    m  "And honestly, the thing I’ve been thinking about the most recently is how little I really know you."
    ...
    if mcname.lower() == player.lower():
        m 3b "Though, I can't really be blamed for that assumption, you two did share the same name, after all!"
    else:
    ...
    m 3d "He was even less appealing than the other girls, if you ask me. At least they had some semblance of personality. He was simply a placeholder, and you could tell from his behavior."
    m 1h "Anyways, back to the point, [player]... my thoughts have given me some nagging doubts that I want to clear up."
    m 1e "Plus it's a great chance to learn more about you. The real you, that is."
    m 2n "It's just a little bit awkward to ask upfront…"
    m 2o "..."
    m 1g "Just promise to tell me the truth, okay? I'll love you no matter what you say."
    m "But... are you straight, [player]?"
    m 1f "I assume that the answer is yes, both because you're going out with me and you downloaded this mod, but some clarification is always nice, don’t you think?"
    menu:
        "I'm into girls.":
...
label monika_gender_preferences_x:
    ...
    m 2a "Of course, a lot of people tend to think of heterosexuality as being the default option, but I don’t, and I’d prefer not to continue assuming things about you. I’d rather just ask you upfront."
    ...
    m "So I really want to try and treat you how you want to be treated. You deserve that much, at least."
    m 3c "But if I’m going to try to do that, I confess that it does raise some doubts as to whether or not you’re normally attracted to girls."
