...
label monika_chobits:
    m 1eua "Hey, [player], have you ever read a series of manga called {i}Chobits{/i}?"
    menu:
        "Yes.":
            ...
            m 1hua "..."
            m 1hub "But do have someone like that! Ahaha~"
            show monika 5eua at t11 zorder 2 with dissolve
            m 5eua "Or maybe that {i}is{/i} something you have in mind when you can."
            m "It might be too soon now, but by the time that becomes possible..."
            m "I guess you could say it could happen, ahaha~"
            show monika 1eub at t11 zorder 2 with dissolve
            m 1eub "We couldn't feel eachother if we tried right now but yet you still love me."
            show monika 5eua at t11 zorder 2 with dissolve
            m 5eua "Maybe someday we will be able to embrace eachother and I'm thankful for you sticking with me until then."
            show monika 1eka at t11 zorder 2 with dissolve
            m 1eka "And as for anyone who thinks our relationship is weird..."
            show monika 5eua at t11 zorder 2 with dissolve
