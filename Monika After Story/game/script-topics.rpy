...
label monika_enjoyingspring:
    ...
    m 2esa "But I think the best thing about spring, would have to be the cherry blossoms."
    m 4eub "They are very popular all around the world, but the most popular cherry blossoms would have to be the {i}'Somei Yoshino'{/i} in Japan."
    m 3esb "Those ones in particular are naturally pure white, with a slight tinge of pink."
    ...
    m 1wub "But rain can also be fun too!"
    m 3hua "We can always go through walks together in the rain, we just have to bring an umbrella big enough for two!"
    show monika 5esbfa at t11 zorder MAS_MONIKA_Z with dissolve
