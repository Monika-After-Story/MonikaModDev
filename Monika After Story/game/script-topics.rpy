...
label monika_trolley:
    ...
    m "Regardless of whether they'd pull the lever or not, most people believe that their choice simply must be the correct one."
    m 1esc "Aside from the two obvious choices, there are also people who'd advocate for a third path - refusing to take part in this scenario at all."
    m 3esc "Though in the end, that really is the same as choosing not to pull the lever. You can't really go back to being a bystander once given the option to act."
