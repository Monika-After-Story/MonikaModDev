...
label monika_anger:
    ...
    m 3n "You saw that when Natsuki and Yuri argued."
    m 2d "Well, an important skill my time in the debate club taught me was how to control anger."
    m 3b "At first I wasn't good at it but I've gradually improved!"
    m 3a"I would always get so frustrated when the club members wouldn't let me talk for minutes on end!"
    m 1q "I thought to myself about how rude and unreasonable it was."
    m "But in the end I was the one letting it hurt me."
    ...
    m 2e "I just want to make sure you're as clear minded and healthy as you can be."
    ...
    m 2j "I find it really soothing myself!"
    m 2b "It's the trick I found myself using most of all."
    m 2a "Sometimes breathing slowly is all you need but it can be surprsingly difficult to do."
    m 2q "When angry, your heart races and as such your breathing becomes ragged."
    m "Taking those slow breathes goes against how your body feels at the time."
    m "It takes quite a bit of determination to do because of it."
    m 3e "I know you can do it though, [player]. I believe in you."
    ...
    m 3n "A character I really liked died and I couldn't believe the author did that!" 
    m "So I simply put the book down and came back to it later."
    m 3l "It's just a story and I let it really get to me."
    m "I was honestly a little embarrassed with myself afterwards."
    m 2c"Unfortunately walking away isn't always an option."
    m "There will be times when you can't leave and have to work through your anger"
