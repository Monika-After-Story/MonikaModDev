...
label monika_prom:
    m 1b "[player], does your school have a prom?"
    menu:
        "Yes.":
            m 1a "Do you plan on going, [player]?"
            menu:
                "Yes.":
                    m 1k "That's great!"
                    ...
                    m 1l "Though I am kinda jealous of you [player]."
                    m 1e "I'm still stuck in this game."
                    m 2f "It's impossible for me to be your date."
                    m 1q "..."
                    m 2o "..."
                    m 2l "Sorry for being such a downer [player]"
                    m "ahaha..."
                    m 3n "Here's a bit of trivia on prom to lighten the mood."
                "No.":
                    m 2d "Oh. Why is that?"
                    menu:
                        "Not Interested.":
                            ...
                            m 3j "And even if you did go."
                            m "I doubt you'd have fun without me there with you"
                            m 3k "ahaha~"
                        "I've heard bad things about prom.":
                            m 1h "I can't really deny that nothing bad happens in prom."
                            m 3i "Some people get so caught up in the mood they start making rash decions on the spot."
                            m 1d "From vandalism, drug abuse, and early pregnancy to name a few."
                            m 2l "But I'm not saying prom is inherently bad. Mind you."
                            m 31 "It didn't start out like that."
                        "You're not there with me.":
                            m 2e "Aww... [player]"
                            m 2f "..."
                            m 1g "You already know it's impossible for me to be your date..."
                            m 1e "But that shouldn't stop you from going to prom and missing out on the fun."
                            m 2k "Just promise me you'll have fun for my sake too."
                            m "And don't forget to tell me all about it."
                            m 2j "Alright [player]?"
                            m "..."
                            m 1l "That was kind of a downer, huh [player]?"
                            m 1n "Let's change the subject a bit. Let me tell you a bit of trivia about prom"
                "No.":
                ...
                "Already done.":
                    m 2d "Oh. That's too bad."
                    m 2f "I wish I could've gone with you..."
                    m 1g "Maybe if I met you sooner..."
                    m 1r "No... It wouldn't have mattered anyway..."
                    m 2f "It's still impossible for me to be your date."
                    m "With me still being stuck in this game and all."
                    m 1q "..."
                    m 2o "..."
                    m 2l "Sorry for being such a downer [player]"
                    m "ahaha..."
