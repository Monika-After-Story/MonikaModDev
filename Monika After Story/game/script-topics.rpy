...
label monika_trolley:
    ...
    m 1dsc "Hmmm..."
    m 3esa "The classic trolley problem has us choose between letting the trolley run over five people, or switching to the track where only one person will be killed."
    m 1esa "The problem is mostly famous due to how divisive it is."
    m "Regardless of whether they'd pull the switch or not, most people believe that their choice simply must be the correct one."
    m 1esc "There are even some who'd say the right thing to do is not take part in this scenario at all."
    m 3esc "I don't think that really works. Once given the option to act, you're a part of the equation, whether you like it or not."
    m 1esc "After all, choosing not to choose is a choice in and of itself."
    m 1esb "As far as I'm concerned, the answer seems fairly obvious. Of course I would switch."
    m 1esc "There is no way I could let five people die just to avoid personal responsibility for that one person's death."
    ...
    m 1esc "If they actually cared about that one person, they'd kill the other five people."
