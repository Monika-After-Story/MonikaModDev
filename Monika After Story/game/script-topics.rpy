...
label monika_solipsism:
    ...
    m 1eua "I do believe we can trust our own existences and doubt others' their own..."
    ...
    m 3eua "I think solipsism is an interesting thought, one that makes you think deeper about what it means to be real..."
