...
label monika_ship_of_theseus:
    ...
    m "If, due to repairs, his ship's parts were replaced bit by bit over a century, at what point has the ship lost its status as Theseus' ship?"
    ...
    m "And as for you...did you know that every 7 to 10 years every cell in your body is eventually replaced?"
