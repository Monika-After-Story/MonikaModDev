...
label monika_materialism:
    ...
    m 3rua "This school of thought is kind of opposite to solipsism, you could say."
    ...
    m 2eua "So our thoughts and feelings are just the movement and reactions of matter, if you simplify it down."
    m 2lksdlb "If we simply stop here, it's not really that interesting. You've probably heard this sort of thing before, right?"
