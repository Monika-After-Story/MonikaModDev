...
label monika_other_girls:
    ...
    m 3q "However, he was just a one dimensional placeholder character for you to use to interact with the game."
    ...
    m 1i "If that's the case, I want to tell you that I'm sorry, [player]."
