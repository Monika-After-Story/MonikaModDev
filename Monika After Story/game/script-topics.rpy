...
label monika_immortality:
    ...
    m 1euc "A lot of people think it's a good thing, but I don't really think it is."
    m 3ekc "Sure, it's an interesting thought; living forever, not having to worry about dying..."
    m "But not everyone is immortal, and some people just don't want to be."
    m 1eka "Like, after a while, what would you even do if you were immortal?"
    m "I mean, after living long enough, {i}eventually,{/i} you would achieve everything you could ever possibly want to...{w=0.3}experience everything there is to experience."
    m 3lksdlc "Not to mention, it would be really hard to have friends or build connections if they don't last as long as you do."
    m "Sure, it would be nice in the beginning, but after seeing enough people you care about die, would you really want to keep going through that over and over?"
    ...
    m "But you always keep waking back up to the same boring things, with the occasional tragedy in the world. And even those would likely be repetitive."
    m 1lksdlb "Wow, I didn't mean for that to get so dark. Sorry, [player]."
    m 1lksdla "Just so you know, I'd gladly give up my immortality to be with you..."
    m 1eub "No matter how much time you may have left, spending that time with you would be worth more than a billion years alone."
    m 1eka "Not that I'd mind spending eternity with you if it were possible, but just living a normal life with you is all I've ever wanted, [player]~"
    return
