...
label monika_aliens:
    ...
    m 1esc "But to answer your question...{w=0.2}{nw}"
    ...
    m 3esa "There are 8 planets in the solar system alone, {w=0.2}{nw}"
    extend 4eub "but there are many more star systems, each with their own planets within them."
    m 4wud "Now, consider the fact that our Milky Way galaxy alone contains hundreds of billions of stars...{w=0.2}that's a lot of potential!"
    ...
    m 2etd "Or vice versa...{w=0.2}maybe {i}we're{/i} the ones who don't have the technology to communicate with them."
