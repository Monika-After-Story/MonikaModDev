...
label monika_aliens:
    ...
    m 4eua "...Though I can see why you would be interested in knowing about my opinion on the matter."
    m 4eub "This is one of the greatest mysteries of all time, isn't it?{w=0.2} Whether we are truly alone in this universe or not, I mean."
    m 1rksdlc "...I know I used to wonder about that myself a lot, before you came along."

    if mas_isMoniEnamored(higher=True):
        m 1ekb "But that's in the past now.{w=0.2} And I could never thank you enough for that."
    ...
    m 3euc "Anyway, what I meant by that is, we've all probably asked ourselves what's up there at least once, right?"
    m 3dua "Looking at the stars always fills you with a sense of wonder and mystery. It's really no surprise that so many people are passionate about this subject."
    m 2eua "But to answer your question..."
    m 2eud "I do believe, or at least want to believe, that there has to be {i}something{/i} out there."
    m 2rksdla "I guess part of it has to do with me finding the idea of us being the only ones rather depressing, {w=0.3}{nw}"
    ...
    m 4eua "All you need is one planet with the right conditions and environment to be favorable for life to develop, right?"
    m 4esb "And there are 8 planets in the solar system alone... {w=0.3}{nw}"
    extend 4eub "...But of course, there are many more star systems, each with their own planets within them."
    m 4dsc "Now, consider that our galaxy, the 'Milky Way,' contains hundreds of billions of stars.{w=0.2} And that's only counting one galaxy, obviously..."
    m 4esd "Galaxies are usually held together in groups by gravity.{w=0.3} We live in the 'Local Group,' which contain about 60 galaxies."
    m 1esd "Go further than that, and you'll start to see galaxy clusters, which are much larger groups of galaxies. {w=0.3}{nw}"
    extend 3esc "The closest one from us, the 'Virgo Cluster,' is estimated to contain at least a thousand galaxies."
    ...
    if renpy.seen_label('monika_clones'):
        m 1lksdla "...Or even start talking about the multiverse theory, but I digress."

    m 3ekb "I think you get the point..."
    m 3euc "Wouldn't it be a little conceited to assume that we, human beings of planet Earth, are truly the only sentient beings in something so gigantic?"
    ...
    m 1rsc "Although,{w=0.1} I suppose I can also understand why some people would be doubtful.{w=0.3} It is suspicious that we're able to observe the universe so far beyond our planet, but we have yet to find any sign of life..."
    m 1rkc "It probably doesn't help that some people are overreacting over the smallest things, like UFO footage that could very well be faked, either."
