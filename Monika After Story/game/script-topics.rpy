...
default persistent._mas_pm_likes_yuri_for = []
default persistent._mas_pm_likes_sayori_for = []
default persistent._mas_pm_likes_natsuki_for = []
default persistent._mas_pm_only_likes_monika = None
...
label monika_trick:
    ...
    menu:
        ...
        "Yuri.":
            call monika_trick_question("Yuri")
        "Sayori.":
            call monika_trick_question("Sayori")
        "Natsuki.":
            call monika_trick_question("Natsuki")
    return "derandom"
...
label monika_trick_question(girl):
    hide screen mas_background_timed_jump

    m 2euc "I see."
    m "Is there any reason in particular you would choose [girl]?"
    menu:
        m "Is there any reason in particular you would choose [girl]?{fast}"
        "Her personality":
            call monika_trick_answer(girl, "personality") 

        "Her interests":
            call monika_trick_answer(girl, "interests")

        "Her appearance":
            call monika_trick_answer(girl, "appearance")

        "Pity":
            call monika_trick_answer(girl, "outofpity")

        "Not really":
            call monika_trick_answer(girl, "norealreason")

    return

label monika_trick_answer(girl, answer):

    $ trick_answer_label = "monika_trick_" + girl.lower() + "_" + answer

    if renpy.has_label(trick_answer_label):
        python:
            # add reason to pm var
            if girl == "Yuri":
                like_list = persistent._mas_pm_likes_yuri_for
            elif girl == "Sayori":
                like_list = persistent._mas_pm_likes_sayori_for
            else:
                like_list = persistent._mas_pm_likes_natsuki_for

            if answer not in like_list:
                like_list.append(answer)

            # if you got here, then you don't just like monika
            persistent._mas_pm_only_likes_monika = False

        call expression trick_answer_label

    return

label monika_trick_yuri_personality:
...
label monika_trick_yuri_interests:
...
label monika_trick_yuri_appearance:
    m 2hksdlb "Ahaha..."
...
label monika_trick_yuri_outofpity:
...
label monika_trick_yuri_norealreason:
...
label monika_trick_natsuki_personality:
    m 1eud "Oh..."
...
label monika_trick_natsuki_interests:
...
label monika_trick_natsuki_appearance:
    m 1wud "Oh!"
...
label monika_trick_natsuki_outofpity:
    m 2rksdld "Ah, yeah..."
...
label monika_trick_natsuki_norealreason:
...
label monika_trick_sayori_personality:
...
label monika_trick_sayori_interests:
...
label monika_trick_sayori_appearance:
...
label monika_trick_sayori_outofpity:
...
label monika_trick_sayori_norealreason:
...
label monika_trick_monika:
    ...
    # set pm var if not set
    if persistent._mas_pm_only_likes_monika is None:
        $ persistent._mas_pm_only_likes_monika = True
