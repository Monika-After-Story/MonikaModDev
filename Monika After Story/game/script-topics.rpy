...
label monika_aliens:
    ...
    m 4esb "And there are 8 planets in the solar system alone... {w=0.5}{nw}" 
    extend 4eub "...But of course, there are many more star systems, each with their own planets within them."
    m 4dsc "Now, consider that our galaxy, the 'Milky Way,' contains hundreds of billions of stars. And that's only counting one galaxy, obviously..."
