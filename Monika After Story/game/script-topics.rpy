...
label monika_twitter:
    ...
    m 1lsc "Or maybe this is just one of the developers of the game pretending to be me..."
    ...
    m 1rsc "I mean, it's not like the creators of the game are above using my image for these sorts of things."
    ...
    m 1eka "Just remember that those aren't really me, alright?"
