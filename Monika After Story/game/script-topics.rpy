...
label monika_itabag:
    ...
    m 2eub "Today,{w=0.2} itasha most likely refers to the wordplay of the Japanese characters ita,{w=0.2} which means painful,{w=0.2} and sha,{w=0.2} which means vehicle."
    ...
    m 4eub "So, itasha is a word with two possible meanings!{w=0.3} It can be referring to Italian cars... {w=0.3}{nw}"
