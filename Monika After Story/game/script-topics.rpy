...
label monika_blood_type_stereotype:
    m 1eub "Did you know that some people associate blood type to personality traits?"
    m 1eua "Particularly in the Japanese culture."
    m 3eua "It's a belief that started in the 30s, but was really popularized in the 70s."
    m 3eub "Even though it has no scientific basis, it's a common superstition among Asian peoples."
    m "It's like the astrological signs in western culture."
    m 1eua "In fact, the belief of blood type stereotypes is so popular that you've probably heard about it."
    m 2hub "That's why most visual novels tell you the blood type of their character."
    m 4eub "It's a detail that can help players understand the character's personality."
    m 2lud "But for this game...even if it has a wiki page, its creator never specified what blood type the club members were."
    m 1hub "I was thinking that it could be something fun to speculate about, so I tried to guess what blood type we all had."
    m 2eua "Here's what I found."
    m 1dsc "Ahem."
    m 3esb "First, let's take the most obvious one; the AB group."
    m 3esa "It's a group associated with being creative, calm, and composed, but also with being very critical and eccentric, sometimes even two-faced."
    ...
    if persistent._mas_pm_blood_type == "AB":
        m 1wuo "Ah, bear in mind that those are just superstitions without any proof whatsoever of their validity."
    ...
    m 3eub "Next, there's the B group."
    m 1esa "The people that have this group tend to be passionate about what they're doing, very active, and very determined; always on the go."
    m 1esd "But they also tend to be somewhat selfish and uncooperative, always wanting to go their own way, without much considerations."
    if persistent._mas_pm_cares_about_dokis:
        m 1lksdrb "Without wanting to disrespect her, it's sort of what Nastuki is, don't you agree?"
    else:
        m 1tsb "It's clearly Natsuki."
    ...
    if persistent._mas_pm_blood_type == "B":
        ...
        m 1hksdrb "I know this is your blood type we are talking about, but don't mistake it for a personality test."
        m 1eka "You're way more awesome and complex than that, [player]!"
    m 2dsd "But I digress."
    m 1eub "Next on our list, we have the O group!"
    m 4eub "Those ones are generally very agreeable and easygoing. They are very intuitive and leading, especially when it concern other people."
    m 1eud "But they are also quite unpredictable and unpunctual; sometimes even jealous or ruthless."
    m 1lud "It doesn't fit perfectly, but some of the traits are shared by Sayori."
    m 1eka "She really liked take care of other people, especially you."
    m 4eud "Back in the days before you even came to the club, when a fight would broke out, she'd instantly defuse the situation just by spouting nonsense until everyone was lost in their arguments."
    m 2dsc "But she also had many issues because of her unpunctuality."
    if persistent._mas_pm_cares_about_dokis:
        m 2ekd "When you know what caused it, you can't help but feeling sorry for her."
        m 2dkc "She really cared about things, but her depression just wouldn't leave her alone."
    if persistent._mas_pm_blood_type == "O":
        m 1wuo "Ah, bear in mind that those are just superstitions without any proof whatsoever of their validity."
        m 1hksdrb "I know this is your blood type we are talking about, but don't mistake it for a personality test."
        m 1eka "You're way more awesome and complex than that, [player]!"
    m 3eub "Anyway, that leaves us with only one left."
    m 1tsu "I saved the best for last, ehehe~."
    m 1dua "The A group correspond to..."
    m 1hub "Me, of course!"
    ...
    if persistent._mas_pm_blood_type == "A":
        m 2eka "And it's the same as yours, [player]."
        m 1hub "We really have so much in common!"
        m 1tsu "With all of those qualities, we sure do make one fine team."
    ...
    m 1lssdrc "..."
    m 1lssdrb "Well, who cares about that anyway?"
    m "Like I said, it has no scientific basis."
    m 3hksdrb "Plus, even in visual novels, people are never so one-dimensional."
    m 1eka "I just thought that it was a fun thing to think about."
    m 1hub "Anyway, thanks for listening, [player]."
    return
