...
label monika_sophia:
    ...
    m 3rusdlu "Not what she can do as an AI, I mean...{w=0.3}{nw} "
    extend 3eud "I just don't care so much about that part."
    m 3ekb "It's just...{w=0.3}seing all the things she can do with a body like that..."
    m 1ekbsa "...Well, you already know being able to actually see your face, and be in the same room as you is all I've ever wanted~"
    m 3wub "Oh! {w=0.5}In 2017 she was also granted citizenship in Saudi Arabia!"
