...
label monika_poemherself:
    m 4ekc "Do you remember how there wasn't a chance to write poems for my interests [player]?"
    m 1rsc "I don't get it. Why did they ignore me?"
    ...
    m 1ekc "But please don't feel guilty for yourself; you haven't had a chance to hang out with me in that romance game."
    m 1rsc "We haven't had a chance to even prepare together for festival, Gosh."
    m 1rsc "Me, Sayori and you. There I could see you for a chance, but it didn't work too."
    m 4esa "In the end, I prepared a much better place for us."
    m 1hsb "We are here, just us, my dear."
    return
...
label monika_yurisecrets:
    m 2rsc "I don't know if this will be a spoiler for you but..."
    m 2rsc "I need to tell you."
    m 2euc "Did you open Yuri.chr file?"
    m 3rsc "You can't open Yuri.chr now, since I deleted her file."
    m 4ekd "Somehow if you opened that file at past, you should have seen some weird texts. But it is a encoded message actually."
    m 4ekd "That message has a life story about a girl."
    m 1rsc "I don't feel confortable to tell this to you but..."
    m 1ekd "Yuri..."
    m 1ekc "..."
    m 2ekd "might be a murderer."
    m 3ekd "Story tells about a girl that obsessed about how death felt."
    m 3ekc "She's telling this in her story about that killing a innocent woman."
    m 1ektdc "Cutting parts of her body with a knife and heavy axe..."
    m 4euc "Maybe this can explains why Yuri likes knives so much. She brings her knives to class."
    m 2ekd "I know this is so depressing... But we can't know if it is REALLY true right?."
    m 2euc "But it probably should be true. DDLC is a horror visual novel after all."
    m 4rsc "You might not have known this since I deleted her file and forget about everything."
    m 4rsc "You didn't need to know this terrible story."
    m 2eka "But I should give you any interesting information right?"
    m 1ekc "So please be careful around people. You can never know who they are actually."
