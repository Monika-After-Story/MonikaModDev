...
label monika_althistory:
    ...
    m "The book is set in alternate 1964 and follows the story of a Kripo detective who is investigating the murder of a high-ranking Nazi Party officer..."
    m "The detective ultimately solves the mystery, but since the murderer is highly placed in a tyrannical regime..."
    m "The murderer ends up becoming the one who pursues and arrests the detective, not the other way around."
