...
label monika_standup:
    ...
    m 4eub "All the while keeping your audience captivated until you reach the punch line; hopefully resulting in lots of laughs."    
    m 1esa "In some ways, it's kind of like writing a short story, except you cut out the falling action."
    m 1esc "And yet between the jokes, you can find the soul of the writer...{w=0.5}what their thoughts and feelings are towards any given subject."
    m 1esd "What their life experiences were, and who they are today."
    ...
    m 3hub "After all, how do you know if your act is good if you never try it out on a crowd?"
    m 4esd "Suddenly, this form of literature becomes much more complex."
    m 4dsc "How you say your lines, your body language, your facial expressions..."
    m 3esd "Now, it's not just about what you wrote,{w=1} it's about how you say it."
    m 1esa "It's kind of like poetry, don't you think?"
    m 2lsc "A lot people won't even try stand-up for themselves because they have to face a crowd..."
    m 4eub "Did you know that the number one fear most people have is public speaking?"
    m 4eub "Number two is death. Death is number two! What's the deal with that?!" 
    m 4eub "This means to the average person, if you go to a funeral, you're better off in the casket..."
    m 4wuo "...than doing the eulogy!"
    ...
    m 1lksdla "...Hmm, maybe I should just work on my own material..."
    return
