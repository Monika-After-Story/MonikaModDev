...
label monika_standup:
    ...
    m 3eub "You reach your final line which is the climax of the piece, hopefully getting the most laughs."
    ...
    m 3hub "After all, how do you know if your bit is good if you never try it out on a crowd?"
    ...
    m 4eub "That means if your average person went to a funeral, you'd be better off in the casket..."
