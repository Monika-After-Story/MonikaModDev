...
label monika_althistory:
    ...
    m "While the genre's popularity has surged only recently, the first known example of alternate history speculation dates back to the times of Ancient Rome..."
    m "A Roman historian named Livy contemplated a scenario in his history book, '{i}Ab Urbe Condita Libri{/i}', where Alexander the Great had surived his fatal fever."
    m "A hypothetical scenario would have him pursue his plans of European expansion and inevitable confrontation of the Argead Empire with the Romans..."
    m "Livy ultimately concluded that this scenario would likely end up becoming a Roman victory."
    ...
    m "He ultimately discovers the truth behind the murders and the culprit is revealed to be Reinhard Heydrich, now leader of the SS."
    ...
    m "Anyway, the murders were carried out to cover up the Holocaust, a fact that mostly remained secret to German public and it's done so to prevent an international scandal."
    m "And since the murderer is highly placed in the tyrannical government, it is him who ends up becoming the one pursuing and arresting the detective, not the other way around."
    m "Therefore, the novel itself subverts the expectations of the reader who expects it to be another typical crime story, albeit set in an unusual scenario."
    ...
    m "That means we wouldn't be able to meet for real, either. It's a terrifying thought..."
    m "Yet here we are, you and I spending time together~"
    m "Well, there's still the matter of different realities, but I'm really happy we're able to do so."
