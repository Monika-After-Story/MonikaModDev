...
label monika_gmos:
    ...
    m 4esd "GMOs can be plants, animals, microorganisms, and more, but we'll focus on genetically modified plants."
    m 7esc "Plants can be modified in a myriad of ways, from resisting pests and herbicides to having a higher nutrition value and longer shelf life."
    m 3wud "This is huge. Imagine crops that can produce double their normal yield, tolerate climate change, and fend off drug-resistant superbugs. So many problems could be solved!"
    m 1dsc "Unfortunately, it's not that simple. GMOs require several years of research, development, and testing before they can be distributed. On top of this, they come with several concerns."
    m 3euc "Are GMOs safe? Will they spread to other organisms and threaten biodiversity; if so, how can we prevent it? Who owns GMOs? Are GMOs responsible for increased herbicide usage?"   
    m 3rksdrb "You can see how this begins to escalate, ahaha..."
    m 1esc "For now, let's cover the main issue...are GMOs safe?"
    m 2esd "The short answer is that we don't know for sure. Decades of research have indicated that GMOs are {i}probably{/i} harmless, but we have next to no data on their long-term effects."
    m 3euc "Additionally, each type of GMO needs to be carefully reviewed on a case-by-case, modification-by-modification basis to ensure its quality and safety."
    m 1lsd "There are other considerations as well. Products containing GMOs have to be labelled, environmental effects must be considered, and misinformation has to be combated."
    m 2dsc "..."
    ...
    m 7esd "As long as we're careful, GMOs will be fine; recklessness and carelessness pose the biggest threat."
    m 6dsc "..."
    m 3eua "So what do you think, [player]?"
    extend 1ttu "Quite the {i}promising field{/i}, wouldn't you say? Ehehe~"
