...
label monika_gmos:
    ...
    m 1euc "With that said, I'm optimistic for the future of GMOs. They're an innovation that has been handled delicately, and that isn't looking to change anytime soon."
    m 1euc "As long as GMOs are tested, regulated, and reviewed, I'm sure that they'll become one of humanity's greatest tools in achieving a happier and healthier future."
    m 1euc "...So what do you think, [player]? Did I manage to persuade you? Ehehe~"
    ...
    m 1euc "There's a lot to it, so be ready for lots of reading!"
