...
label monika_allegory_of_the_cave:
    ...
    m 3euc "All they can hear is the voices of the people moving the objects around and, since they can't see behind them, they think that the voices are coming from the shadows."
    ...
    m 3esc "The prisoner wouldn't be able to see for some time because they'd be so used to the darkness of the cave."
    m 3eud "But{w=0.3} after a while, their eyes would adjust. Eventually, they'd learn about color, nature, and people."
