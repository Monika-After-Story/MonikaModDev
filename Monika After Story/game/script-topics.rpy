...
label monika_procrastination:
    ...
    m 3ekd "And you knew would take a lot of time, so you just kept putting it off?"
    m 1hua "Well, when you have a task to do like that, I find it's best to just do it as soon as possible and get it done."
    ...
    m 4dkd "And what's worse is that the longer you put it off, you'll only increase the odds of more tasks getting added."
    m 2rkc "Until eventually, you end up with so many things to do it seems impossible to ever get caught up."
    m 41hksdlb "It creates too much stress that can be easily avoided if you just keep on top of things in the first place."
    m "Plus, if other people are counting on you, they'll start to think less of you and find that you're not very reliable."
    ...
    m 1hub "Because then you'll be less stressed and we can enjoy our time together that much more!"
    m 3eua "So if you have something you've been putting off, why don't you go do it right now?"
    m 1hua "And if it's something you can do right here, I'll stay with you and provide all the support you need."
    m "Then, when you're done, we can celebrate your accomplishment!"
