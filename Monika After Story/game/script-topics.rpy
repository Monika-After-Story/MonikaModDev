...
label topic_physical_media:
    ...
    m 1eud "Except for optical disks, which are only used for game consoles now."
    ...
    m 1euc "With all these digital-aimed tendencies, it might be worth asking: "
    ...
    m 3euc "While having to find, and put a CD or a cassette into a reader is inconvenient,"
    extend 4eub " it also makes it much more rewarding to use the media in it."
    m 1eud "Plus, digital media might not always be available: "
    extend 3euc "Servers can go down at any time,"
    ...
    m 6eua "That being said,"
    extend 4hksdlb " please don't put me on a CD. "
