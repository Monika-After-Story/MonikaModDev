    ...
    if not persistent.clearall:
        addEvent(
            Event(
                ...
                random=True,
                key_words="lingering_1 linger_1 other_1 girls_1 sayori_1 natuski_1 yuri_1"
            )
        )
...
init 5 python:
    addEvent(
        Event(
            ...
            random=True,
            key_words="hate_1 hater_1 haters_1"
        )
    )
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hydration",prompt="Hydration",category=['you','life'],random=True,key_words="hydration_1 water_1"))
