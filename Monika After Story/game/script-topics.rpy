...
label monika_itabag:
    ...
    m "I started seeing them online recently and I decided to look into them."
    ...
    m 2eub "The word today is a wordplay on the Japanese characters ita,{w=0.2} which means painful,{w=0.2} and sha,{w=0.2} which means vehicle."
