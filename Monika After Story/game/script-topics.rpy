...
label monika_round_earth:
    m 7eua "Hey, [player]."
    m 6eua "What do you think the earth is? Round or flat?"
    $ _history_list.pop()
    menu:
        m "What do you think the earth is? Round or flat?{fast}"

        "Round":
            m 4eub "Right! Pretty much everyone agrees on that these days."

        "Flat":
            m 1eub "Oh, come on, [player]! Are you making fun of me?"
    
    m 4eua "Actually, the earth being round is something that has been known for a very long time."
    m 3eua "Aristotle taught that the earth was round in the fourth century BC."
    m 3eua "He knew that because different stars could be seen from different parts of the world, which wouldn't happen if the earth was just a flat surface."
    m 6eua "Ancient astronomers and mathematicians around the world had figured out that the earth was round long before anyone had actually travelled all the way around it."
    m 6wud "But earth being the centre of the universe? Oh man!"
    m 6dkd "People fought about that so hard and for so long. It became a matter of life and death."
    m 6ekd "The astronomer Galileo was put on trial for heresy for saying that the earth was not the centre of the universe. He was placed under house arrest for the rest of his life."
    m 6euc "But as astronomers got better at tracking the movement of planets, it became kind of difficult to reconcile with the earth being at the centre."
    m 7euc "People had to come up with some crazy complex models to explain why planets seemed to zig-zag back and forth across the night sky if they were really going around the earth."
    m 4etc "Nowadays, they say that even the sun isn't at the centre of the universe--it's just one of many stars in the galaxy."
    m 1tsblu "Do you know where science says the centre of the universe is now?"
    m 3ksbsu "It's you. You're the centre of my universe, [mas_get_player_nickname()]."
    m 3hsbsb "Ahaha!"
