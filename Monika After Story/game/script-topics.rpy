...
label monika_intrusive_thoughts:
    ...
    m 3eud "I've been reading a study on them...{w=0.5}it's actually quite interesting."
    ...
    m 4esa "A good person would never act on their intrusive thoughts.{w=0.4} {nw}"
