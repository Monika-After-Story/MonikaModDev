...
label monika_fastfood:
    ...
    m 1m "Honestly, the thought of it slightly disgusts me."
    ...
    menu:
        ...
        "Yes, I do.":
            ...
            m 3g "If I were there I would cook much healthier things for you."
            m 3p "Even though I can't cook very well yet..."
            m 3n "Well, having my love in it would make it tastier than any fast food!"
            m 1f "[player], would you do something for me?"
            m  "Would you try to eat better? Please?"
            m 1q "I would hate it if you became sick because of your lifestyle."
            m 1h"I know it's easier to order out and preparing your own food can be a hassle..."
            m 1e "But maybe you could see cooking as an opportunity to have fun?"
            m 1h "Or perhaps a skill for you to become really good at?"
        ...
        "No, I don't.":
            ...
            m  "Fast food can be really expensive over time, so doing it yourself is usually cheaper."
            m 1b "It also tastes a lot better!"
            m  "I know people find cooking overwhelming..."
            m 1m "If only because managing to keep enough ingredients is really inconvenient..."
            m 1k "But I think I think the results are worth the effort."
