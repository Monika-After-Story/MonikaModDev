...
label monika_renewable_energy:
    ...
    m 3esc "Fossil fuels are incredibly efficient, time-tested, and have widespread infrastructure, but they're also non-renewable and emission-heavy."
    m 3euc "Mining and drilling for fossil fuels results in air and water pollution, and oil spills devastate ocean life."
    ...
    m 5eua "Well, there's been a lot of progress made on renewable energy in the past few decades."
    show monika 3eua at t11 zorder MAS_MONIKA_Z with dissolve_monika
