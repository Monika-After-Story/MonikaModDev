...
label monika_floriography_birth_flower:
    ...
    m 1eub "It's a pretty old concept, found all over the world."
    m 2lku "It might be harder to point out a culture that {i}didn't{/i} {w=0.2} have some version of floriography than those that did."
    ...
    m 2esa "At the very least, it could help you choose sometimes!"
    m 2esa "And just like wearing a birthstone... {w=0.2}{nw}"
    extend 2eua "it can still be fun, right?"
    ...
    m 1hsb "I hope you think that floriography is interesting too!"
    m 1hsu "Just make sure not to take it {i}too{/i} seriously~"
...
label monika_floriography_monika_birthflower:
    ...
    m 3wud "There are actually even birth{w=0.4}{i}day{/i} flowers in Japan it seems!"
    m 1eub "I was able to find quite a lot of both flowers and meanings when I looked mine up."
    m 1gusdla "Now I can see why people tried to make floral dictionaries just to try to keep everything straight~"
    ...
    m 1esa "I'm sure you've seen hibiscus before. {w=0.2}{nw}"
    extend 1eta "They make most people think of summer rather than fall, I think."
    ...
    m 6hubfb "And I'm so happy we're together now.{w=0.4}"
    ...
    m 5sublb "Do you think you could pick me some for my next birthday?"
...
label monika_floriography_hamlet:
    ...
    m 3eua "If the decoder knows the meaning of the flowers, they can get even more out of what isn't explicitly stated. {w=0.3}{nw}"
    extend 3eub "Or even understand it has a different meaning entirely!"
    m 1esa "If you've read Hamlet you might be somewhat familiar with an example of this..."
    m 1eka  "I remember being pretty confused when I had to read it in school... {w=0.3}{nw}"
    extend 1lka "I don't know what I would have done if there weren't notes explaining it on the opposite page."
    m 1esa "While flowers show up multiple times in the play, they are fairly significant in a late scene with Ophelia."
    m 1ekc "At that point in the play, she's driven insane by grief and her words don't make much sense."
    m 7esb "But she can communicate what she's feeling and what she knows through the choices of flowers that she hands to other characters."
    m 7eua "So it's not just the flower itself,{w=0.5}{nw}"
    extend 7eub " but {i}who{/i} she gives which flower to."
    m 7esa "For example, as she's handing some to the Queen, she says"
    m 2esd "{i}There’s rue for you, {w=0.4}{nw}"
    extend 2dsd "here’s some for me;{/i}"
    m 2esc "{i}We may call it herb of grace o’ Sundays.{/i}"
    m 2fsc "{i}You must wear your rue with a difference.{/i}"
    m 1ekc "The only thing that's clear from what she puts into words is that the whatever meaning the rue has isn't the same for both of them."
    m 1esd "Because rue is bitter and smells unpleasant, it can symbolize regret, disdain, sorrow, or distress."
    m 1esc "Rue was also used to sprinkle holy water, {nw}"
    extend 1euc "so it could associated with repentance too."
    m 7esd "Does Ophelia intend to mean that the queen should regret what she's done {w=0.1}{nw}"
    extend 7eud "and that she should and can repent?"
    m 7euc "Does it mean that she disdains the queen {w=0.3}{nw}"
    extend 7ekc "or does it mean she wants to commiserate with her?"
    ...
    m 7eub "When you use a plant symbolically, just like with any other literary device, it certainly gives the reader or listener a lot more to analyze and think about!"
    m 7eud "But... {w=0.4}if you're writing, I highly suggest that it you make sure it adds more layers to you work, instead of making it the foundation for understanding."
    m 7tuc "It turns out this is particularly important if you're trying to write a {nw}" 
    extend 7muc " classic."
    m 7esb "Anyway,{w=0.3} I hope you don't {w=0.3}{nw}"
    extend 7nsb "rue the day{w=0.6} that you learned about floriography."
    m 7hsb "Ehehe~"
    return
