...
label monika_promisering:
    ...
    if not persistent._mas_acs_enable_promisering:
        m 1hubsa "I wish I could get one for myself. I'm sure I'll find a way to add one in here in time."
        m 1eua "And then I could wear it forever."
        m 3ekbsa "But until then, just remember that my commitment to you is unwavering."
    else:
