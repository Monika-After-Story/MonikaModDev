...
label monika_player_away:
    ...
    m 3eua "I really recommend doing a search for some free short stories yourself."
    m 3esd "It's also helped me develop my writing skills...{w=0.2}{nw}"
    extend 1hub "my poetry really seem to be improving!"
    ...
    m 3eud "As you can imagine, I practice piano quite often."
    m 3eua "I also use the time to memorize the songs that I sing for you."
    ...
    m 3esd "Coding, for example, takes up a lot of my freetime."
    m 1eud "I often spend hours just learning and researching."
    m 3rksdla "Most of the time I'm too nervous to put any super big projects into the spaceroom."
