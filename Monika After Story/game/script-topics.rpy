...
label backpacking:
    ...
    m 3rublsdla "We probably won't have any bathing suits with us, but there won't be anyone else around so we won't need them..."
    m 1hublsdlb "Ehehe~"
    m 1esbla "..."
    ...
    m 5sub "I can't wait until we can share this experience together."
