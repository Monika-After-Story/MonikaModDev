...
label monika_driving:
    ...
    m 3j "Walking or cycling can be really nice sometimes too!"
    m 1a "I guess you could say I never really needed to be able to drive."
    m 1o "I'm not sure I would even have had time to learn to drive with school and all the activities I did anyway."
    ...
    menu:
        "Yes.":
            ...
            m 1e "Driving can also be dangerous too though, but if you can drive, you probably already know that."
            m "Anything could happen at any time."
            m 3e "No matter how prepared you are, accidents could happen to anyone."
            m 2l "I mean, I know you're smart but I still worry about you sometimes."
            m 2e "I just want you to come back to me safe and sound is all."
            m 1e "I hope you've never had to experience that, [player], have you?"
            menu:
