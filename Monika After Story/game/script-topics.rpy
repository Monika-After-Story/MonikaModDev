...
label monika_i_love_you:
    m 1f "[player], I love you."
    m 1f "with all my heart."
    m 2g "you know that right?"
    m 3h "I dont know what I'd do without you."
    m 5 "You mean so much to me."
    m 1e "please, never forget that."
    return
