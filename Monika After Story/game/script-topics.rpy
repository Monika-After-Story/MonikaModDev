...
label monika_writingtip_1:
    ...
    m "If you and the rest of the literature club weren't there to help me get better and be more confident in my writing, then I don't think I'd be able to write poetry nearly as well."
    m "Not that I don't still have room to improve, Ahaha."
