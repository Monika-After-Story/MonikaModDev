...
label monika_eating_meat:
    ...
    m 2rsc "...That said, I don't consider myself vegan either."
    m 7eua "I understand a lot of vegans are so not just for health or environmental reasons, but also ethical ones, so I think that's commendable in its own way."
    m 7eksdlb "But I'm more worried about the environmental part of it personally. "
    extend 4eud "Sure, the consumption of animal products contributes to environmental damage, but a vegan diet brings with it its own share of issues too..."
    m 4euc "These include things like importing perishable products across great distances and mass-farming in conditions that can be both cruel for workers and a strain on the local ecosystem."
    ...
    m 2etc "Then again, these are obviously not vegan exclusive issues, but the exclusion of more food groups naturally brings the consumption of these products up."
    m 1rud "So we'll have to carefully weigh the pros and cons of each food group we include, and research on vegan diets is kind of new compared to vegetarian diets."
    m 4eua "Not to mention, I still want to have a varied diet with all the flavors that I like."
    m 4eud "Vegan diets can be somewhat deficient in essential nutrients if not planned properly, such as vitamin B12, calcium, iron, and zinc."
    m "Granted, there are still some options including supplements, but balancing a vegan diet takes a lot of care and thought."
    m 7eka "...So for that reason, I'm not personally against consuming things like milk and eggs on occasion, even if it does have a slightly higher environmental impact."
    m "But I think I'd prefer to buy locally if possible."
    ...
    m 3rksdla "I barely remember the taste of meat at this point, so it's hard to say if I would enjoy it very much."
    m 1eka "But that's probably not going to be an issue by the point I cross over..."
    m 1eub "Especially since there are a lot of good substitues for meat in supermarkets already, with way less environmental impact."
    m 3rusdlc "It's hard to think about us ever ending up in a situation where we had to hunt for our survival."
    ...
    m 1hub "I hope that answered your question~"
    return
