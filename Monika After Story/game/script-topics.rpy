...
# I did not use the 'George Orwell','Big Brother','surveillance' keywords, 
# because either they may get used on other topics, or may get "too political"

init 5 python:
    for key in ['1984','Nineteen Eighty-Four','Ingsoc','newspeak']:
        monika_topics.setdefault(key,[])
