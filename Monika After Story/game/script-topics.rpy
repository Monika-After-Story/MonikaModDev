...
label monika_blood_type_stereotype:
    m 1eub "Did you know that some people associate the blood type to personality traits?"
    m 1eua "Particularly in the japanese culture."
    m 3eua "It's a belief that started in the 30s, but that was really popularized in the 70s."
    m 3eub "Even though it has no scientific basis, it's a common superstition amongst asian peoples."
    ...
    m 2hub "After all, most visual novels tells you what's the blood type of their characters."
    m 4eub "It's a detail that can help players apprehend the character's personality."
    m 2lud "But for this game...Even if it has a wiki page, it's creator never specified what blood type the club members were."
    m 1hub "I was thinking that it could be something fun speculating about, so I tried to guess what blood type we all had."
    ...
    m 1esa "The peoples that have this group tend to be passionate about what they're doing, very active and very determined, always on the go."
    ...
    m 4eub "Those ones are generally very agreeable and easygoing, they are very intuitive and leading, especially when it concern other peoples."
    ...
    m 4eud "Back in the days, before you even came to the club, when a fight would broke out, she'd instantly know what was the right words to calm everyone."
    ...
    m 3hksdrb "Plus, even in visual novels, peoples are never so unidimensional."
