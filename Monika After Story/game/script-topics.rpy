...
label monika_architecture:
    m 1esa "Hey, [player]! You know, I think there's this one major art branch that we've been neglecting in our talks..."
    m 3eub "Architecture!"
    m 3esa "I've been reading a bit about it lately, so I find it quite interesting to discuss..."
    m 1eua "Come to think of it, architecture is one of the most common kinds of art in your everyday life."
    m 1tub "Unless you live in a complete wasteland of some kind...{w=0.5}{nw}"
    extend 1hub " Ahaha~"
    ...
    m 1ruc "Modern architecture focuses more on getting things done in a more practical way."
    m 1euc "In my opinion, it can be both good or bad for many different reasons." 
    m 3euc "Still, I believe the most important part is to keep things balanced."
    m 1tkc "Overly-practical buildings can look flat and uninspired just as the overly-artistic buildings can serve absolutely no purpose other than looking out of place."
    ...
    if mas_isMoniAff(higher=True):
        ...
        m 1hub "Ahaha~"
    m 1eka "[player]... {w=1}Seeing the world with you is one of my biggest dreams."
