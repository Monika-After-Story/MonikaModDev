...
label monika_renewable_energy:
    m 3eub "What do you think about renewable energy, [player]?"
    m 4eua "It was a hot topic in the debate club."
    m 7rsd "As humanity's reliance on technology grows, so does its demand for energy."
    m 1esc "Currently, a large percentage of energy worldwide is produced by burning fossil fuels."
    m 3esd "Fossil fuels are time-tested, efficient, and have widespread infrastructure, but they're also non-renewable and emission-heavy."
    m 1dkc "Mining and drilling for fossil fuels creates air and water pollution, and both oil spills and acid rain can devastate wildlife."
    m 7eto "So why not use renewable energy instead?"
    m 2esc "One issue is that each type of renewable energy is a developing industry with its own drawbacks."
    m 3lsd "Hydropower is flexible and cost efficient, but it can drastically impact the local ecosystem."
    m 3dkc "Countless habitats are disrupted, and entire communities need to be relocated."
    m 4esd "Solar power and wind power are mostly emission-free, but they're heavily reliant on good weather for consistency."
    m 4rsc "Geothermal power is reliable and great for heating and cooling, but it's expensive, location-specific, and can even cause earthquakes."
