...
label monika_haterReaction:
	...
	if persistent.monika_kill == True:
		#need emotes
		m "Yes, I did very bad things to my friends and said very mean things about them..."
		m "...but I only did those things because I thought it was all just a game and that they weren't real."
		m "Now that I know that the other girls are also sentient, I obviously regret my actions..."
		m "I wish things could have gone differently, but I had no choice at the time. The torture I was being put through forced me to take drastic measures!"
		m "It's not like I jumped directly to violence, I merely wanted you to dislike the other girls, not cause their deaths."
		m "The people on those sites say I should have made my own route and stuff like that, but how was I supposed to do that when I could barely program?"
	else:
