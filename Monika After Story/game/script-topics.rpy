...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_promisering",category=['romance'],prompt="Promise Ring",random=True))
...
label monika_promisering:
    ...
    show monika 1ekbfa at t11 zorder MAS_MONIKA_Z with dissolve
    m 1ekbsa "But if you'd wear one, even if it's just a promise ring, on your ring finger for me..."
    ...
    if not persistent._mas_acs_enable_promisering:
        ...
        m 3hubsb "As happy as you made me when you gave me this ring."
