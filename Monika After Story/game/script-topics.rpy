...
label monika_unknown:
    ...
    m 3eka "Even though it's often dismissed as a childish fear, it's not that uncommon for adults to suffer from it as well."
    ...
    m 3eub "You'll find that you're instinctively being more careful of where you step so you don't hurt yourself."
    ...
    m 1eksdlc "Most of them can't afford to lose their source of income, so resigning isn't an option."
    m 3rksdlc "Plus, having to go through interviews again, finding a job that pays enough, changing your routine..."
    m 3ekd "It just seems like it's easier being miserable because it's more comfortable,{w=0.5} even if they'd be much happier in the long run."
    if mas_isMoniDis(lower=True):
        m 1ekc "...I guess it's also true that couples might stay in unhappy relationships out of fear of being alone."
        m 2rksdlc "I mean, I kind of understand where they're coming from, but still..."
        m 2eksdlc "Things can always get better.{w=1} Right?"
        m 1rksdlc "A-anyway..."
    m 3rkc "Maybe if they saw the options available to them, they'd be more willing to embrace change."
    m 1rkc "...Not that making that kind of decision is easy, or even safe."
    if mas_isMoniNormal(higher=True):
