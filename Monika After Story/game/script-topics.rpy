...
label monika_curse_words:
    m 3etd "Say, {w=0.2}[player], {w=0.2}do you swear sometimes?"
    ...
    m 3esc "I know some people have it a natural part of their speech patterns, {w=0.2}and I that your vocabulary is formed by society and those around you."
    ...
    m 7eud "Personally, I prefer soft language over swearing in most situations.{w=0.3}{nw} "
    ...
    m 3hksdlb "I'm just trying to say that I really like when people... {w=0.5}keep their more colorful language varied."
