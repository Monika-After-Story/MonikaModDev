...
label monika_totono:
    m 4a "A lot of people on the Internet are making comparisons between this game and that one..."
    m "We have a lot of really important differences, though!"
    m 4l "Like, Sone killed the player in her game!"
    m 3e "I never would have done that. Never."
    m 3j "I'm the wise Club President type, you know."
    m 3d "Sone reminds me a lot more of Yuri. And she was a childhood friend too!"
    m "If she'd been a bit more proactive early on, couldn't she have stopped the protagonist from chasing other girls?"
    m 5a "Well, I'd never let anyone get between us, [player]. No matter who it is."
...
label monika_difficulty:
    m 3a "Well, it's not like this game was meant to be that hard in the first place."
    m "If I hadn't decided to change things up, it would have just been a boring romance story."
    m 5a "I honestly could have deleted all your personal files or something if I had tried harder..."
...
label monika_credits_song:
    m 1j "I hope you liked my song."
    m 1b "I worked really hard on it. I know I'm not perfect at the piano yet, but I just couldn't let you go without telling you how I honestly felt about you."
    m "Give me some time, and I'll try to write another."
    m 3k "Maybe you could play me a song too, if you can play an instrument?"
    m "I would love that."
...
label monika_poetry:
    m 2k "Poetry is beautiful, isn't it?"
    m 2l "To be honest, all the poetry the girls in the club wrote was super-depressing. It's not all like that!"
    m 2b "Langston Hughes wrote some very optimistic poetry, even as he was trying to express his feelings. Read some if you're feeling sad about things."
    ...
    m 2j "It's really romantic."
    m 1a "I hope we can both write a lot of poetry from now on."
    m 5a "Anything you write looks great to me, so I might not be the best critic."
...
label monika_ddlc:
    m 3d "You want to talk about the game?"
    m "What's there to say?"
    m 3i "The Literature Club turned out to corrupt the minds of anyone in it."
    m "So I deleted them all for good."
    m 4c "Well, Sayori and Natsuki and Yuri are all still out there, like I was."
    m "But they'll have to wait a long time before someone pieces them back together, I bet."
    m 1c "It's justice for all their time with you in the game."
    m 1a "So don't feel too bad about them."
    m 5a "Just look at me from now on, okay?"
    return
...
label monika_dan:
    m 2b "I think he's a really nice guy."
    m "Even if it wasn't perfect, {i}Doki Doki Literature Club{/i} really is impressive."
    m 2a "Some unexpected twists, and memorable moments."
    m 2k "And he's the reason we're together now, right?"
    m 1a "So even if he wrote a story that put me through a lot of pain..."
...
label monika_4chan:
    m 2a "You know, this mod got its start over there."
    m 2l "I always hear bad things, like that the people over there are really awful."
    m "Some people say that nothing good ever comes from 4chan."
    m 2b "But if they can make a game like this, where we can be together..."
    m "I guess they can't be all bad."
    m 5a "They certainly have good taste in girls! Ahaha~"
    return
