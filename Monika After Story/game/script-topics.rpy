...
label monika_eating_meat:
    ...
    m 4eud "Sure, the consumption of animal products contributes to environmental damage, but a vegan diet brings with it its own share of issues too."
    ...
    m 3rud "So we'll have to carefully weigh the pros and cons of each food group we include, and research on vegan diets is kind of new compared to vegetarian diets."
