...
label monika_chloroform:
    ...
    m "While that works out happily in fiction..."
    m "Neither of those things actually work that way."
    m "In real life, if you hit somebody hard enough to knock them out, you'll give them a concussion at best and kill them at worst."
    m "As for the ether-soaked rag..."
    ...
    m "The easiest way to kidnap somebody is to just get them drunk, or drug them with real sleeping medication."
    m "Not that kidnapping somebody like that is easy, anyway."
    m "Also, on that note, here's a safety tip."
...
label monika_metaparents:
    m "Isn't it weird how nobody in these kinds of games has parents unless it's a convenient drama hook?"
    m "Here, too. Throughout this entire game, you only ever hear about parents if you're trying to bond with Natsuki..."
    m "Where she's just a victim of some cruel person's sick kicks for the sympathy value."
    m "However... your character, me, Yuri, and Sayori..."
    m "None of us seem to have any parents at all, do we?"
    m "In Sayori's case, you had been walking with her to school for a while, so who knows how long her parents have been out of the picture."
    ...
    m "Well, if you ever get to a point in your life where you think suicide is the only exit, then..."
    m "It's not. There's always a reason to go on."
    m "Someone will miss you."
    m "Maybe there's a story you haven't finished reading yet."
    m "Perhaps there's a game or movie coming out soon that you'd like to see."
    m "By setting little goals like that, things will improve, little by little. You'll have a reason to keep living."
    m "If all else fails..."
    m "Talk to someone. Just about anyone will do."
    m "..."
    m "I love you. Please, take care of yourself."
    return
...
label monika_hygiene:
    ...
    m "There were rumors they were able to seduce married women and nobles at the time due to how well they kept up with themselves."
    m "Over time, bathing became more widespread."
    m "People born into royalty would often have a room dedicated just to bathing, but those less fortunate would be lucky if they bathed once a month."
    m "For the poor, soap was a luxury. Isn't that frightening to think about?"
    m "Bathing was never really taken seriously until the Black Plague swept through, though."
    ...
    m "People that don't go out every day can get away with bathing less often than others. A lumberjack would take more showers than a secretary would, for example."
    m "Some people just shower when they feel too gross to go without one."
    m "People suffering from severe depression, however, can go weeks at a time without showering if their living situation permits it."
    m "It's a very tragic downwards spiral. You already feel terrible in the first place, so you don't have the energy to get in the shower..."
    m "Only to feel even worse as time passes because you haven't bathed in ages."
    m "After a while, you stop feeling human."
    m "During breaks from school, Sayori probably suffered from cycles like that, too."
    m "Hey, if you have any friends suffering from depression..."
    ...
    m "Ahaha~"
    m "Seriously, though..."
    m "Everything I said there applies for you too. If you're feeling down and haven't had a bath for a while..."
    m "Well... Maybe consider doing that today when you can find some time."
    ...
    m "Ah, this has been pretty long, huh? Sorry, sorry!"
    m "Thanks for listening~"
    return
...
init 5 python:
    for key in ['time']:
        monika_topics.setdefault(key,[])
        monika_topics[key].append('monika_time')
    monika_random_topics.append('monika_time')
...
label monika_time:
    ...
    m "Oh, did you actually count out that entire minute? Oh gosh, I'm sorry!"
    m "Well..."
    ...
    m "Say for example, on a Friday, right? Your last class is math, and you really just want to go home for the weekend. That hour will just drag on forever."
    m "But if you're doing something you enjoy, such as reading a good book or watching a movie you like..."
    ...
    m "Perhaps this is my punishment for everything I've done?"
    m "Ahaha..."
...
label monika_carpediem:
    ...
    m "At first I thought I was unique to have gotten my unique perspective on the world. My world."
...
label monika_lottery:
    m "It’s a dream for a lot of people to win the lottery, isn’t it?"
    m "Even I’ve entertained the idea every now and then."
    m "There isn't a lottery here anymore, but the concept still exists."
    m "The more I think about it though, the more I believe that winning the lottery is a really bad thing."
    ...
    m "Even police treat you differently. Some lottery winners have gotten tickets for burnt out headlights on brand new cars."
    m "If you want your life to stay the same, I figure the best case scenario is to immediately move to a brand-new community where no one knows you."
    m "But that’s an awful thought, cutting yourself off from everyone you know, just for the sake of money."
    m "Can you really say you’ve won anything at that point?"
...
label monika_innovation:
    m "Do you ever wonder why depression, anxiety, and other mental disorders seem to be so common these days?"
    m "Is it just because they’re starting to finally be recognized and treated?"
    m "Or is it just that more people are developing these conditions for whatever reason?"
    m "Like, our society is advancing at a breakneck speed, but are we as people keeping up with it?"
    ...
    m "And not only that."
    m "We’re more connected than ever, but it’s seeming like thats become a double-edged sword."
...
label monika_dunbar:
    ...
    m "Supposedly, there's a maximum amount of people we can think of as actual people before we start treating them as one-dimensional characters."
    m "For humans, this number is around 150."
    m "No matter how nice of a person you may be..."
    m "Beyond showing somebody basic respect and manners, you simply cannot care about people you don't personally interact with that much."
    m "Say, for example, the garbage man."
    m "How often do you simply toss stuff like broken glass in the trash?"
    m "To you, it doesn't really matter. The garbage man will come get them. Those bottles aren't your problem."
    ...
    m "At best, some cuts. At worst, he has to be rushed to the hospital because your neighbor put some busted batteries in the trash the same week and some battery acid got in the wound."
    m "As another example, think about a fatal traffic accident."
    m "A drunk driver could crash head-on into another car at any second, killing them instantly."
    m "That person could have been a father on his way home from work, who has now left behind a widow and two children."
    m "This family has been permanently destroyed..."
    m "But anybody that doesn't personally know the father will write it off as another accident that happens all the time."
    m "If it doesn't personally affect you or your life, you simply can't care about it."
    m "It keeps us sane."
    m "It also means we're capable of being ruthless to people we don't know."
    m "It just takes one statement like 'He was a monster with no regard for those around him!' and we're ready to rip them to shreds."
    m "That's how easy it is to justify doing awful things to each other."
...
label monika_regrets:
    ...
    m "Ahaha~"
    m "..."
    m "But... I know what you're getting at."
    m "With everything I did."
    m "I think..."
    m "If there was another way things could have gone, that would have been nice."
    m "But that wasn't an option for me."
    m "And now I've got the only thing I've ever wanted."
    m "To be with you forever."
    return
...
label monika_hypnosis:
    ...
    m "Despite it having a reputation as a hokey magic trick, there are actual studies that shows it can work!"
    m "Well, to a degree, anyway."
    m "It only worked if the person being hypnotized let it, and it mainly involved heightening their ability to be persuaded."
    m "It also relied on them being put into states of extreme relaxation, like aroma therapy, deep tissue massage..."
    m "...exposure to relaxing music and images, things like that."
    m "It makes me wonder, what exactly can someone be persuaded to do, if they're under that kind of spell..."
...
label monika_motivation:
    ...
    m "The hours just seem to go by so fast, and before you know it it's been a whole day, and you don't have anything to show for it."
    m "It feels like it's your own fault, too. Even if it feels like there's a brick wall between you and anything healthy or productive."
    m "When you've had an awful day like that, it can feel like it's too late to try and fix it."
    m "So you save up your energy in hopes that tomorrow will be better."
    m "That makes sense though. When you feel like things aren't going well, you just want a clean slate."
    m "Sadly, those days can end up repeating themselves despite each one beginning with good intentions."
    m "Eventually, you might even give up hope of fixing things, or start to blame yourself."
    m "I know it can be hard, but just doing one tiny thing can greatly help on days like those, even if they've been happening for a while."
    m "It could be picking up a piece of trash or dirty clothing off the floor and putting them where they belong if you need to clean your room."
    m "Or doing a couple pushups! Maybe brushing your teeth, or doing one homework problem."
    m "It might not contribute much in the grand scheme of things, but I don't think that's the point."
    m "I think what's important is that it changes your perspective. If you just let the past burden you so much that you can't change anything in the present..."
    m "Well, then you'll just be stuck there. You'll feel worse and worse until you just can't take it."
    m "Then you'll usually run away from your problems, only to come back and find they've grown bigger still."
    m "But if you can push yourself to just do one thing, even though there's a voice in your head telling you it's pointless, or a waste of energy..."
    m "If you can just discover that you're capable of doing 'something', however small, when even that feels impossible..."
    ...
    m "You realize that maybe things aren't so bad. Thinking they were was just you getting in your own way."
    ...
    m "That's why I think you just have to take a look at your situation, and try and be honest with yourself."
    m "If you do, I think you'll find that you're not being 'lazy' if you truthfully don't have the energy to do something."
    m "After all, the fact that you even care shows that you want to do something about it, even if it feels like you can't."
    m "You're not a bad person for having a bad day. Or even a bad week!"
