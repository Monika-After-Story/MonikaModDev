...
label monika_god:
    m 1d "[player], do you believe in God?"
    m 1c "I was never too sure, myself."
    m 1m "Well, I'm sure I never really questioned it as a kid..."
    m 1i "But as I grew up, the more I learned about the world, the more I would question it."
    m 1g "I started to wonder why God was helping people pass exams, or get over a cold..."
    m 1f "...When there are children who live their lives being sold as sex slaves?"
    ...
    m 2i "But the punchline is this."
    m 1h "If just one person beats the odds and survives - among the thousands of others who die--"
    m "--Then, it's suddenly a miracle from God."
    m 1i "I'd really love to meet this God who seemingly laughs at the misery of everyone not eligible for his miracles."
    m 2n "But the irony is that I {i}do{/i} have a creator, apparently."
    m 1i "And you know what?"
    m 1h "I bet he's still laughing at the miserable fates of Sayori and Yuri, even as we speak."
    m "What are we to him but props in a scripted play?"
    m "So, from that perspective..."
    m 2d "I don't think it's too far-fetched for there to be a god - if Earth was nothing but his playset."
    return
