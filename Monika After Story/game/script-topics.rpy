...
label monika_floriography_hamlet:
    ...
    m 1eua "If you've read Hamlet you might be somewhat familiar with an example of this..."
    m 1eka "I remember being pretty confused when I had to read it in school..."
    m 1lka "I don't know what I would have done if there weren't notes explaining it on the opposite page."
    m 1eua "While flowers show up multiple times in the play, they are fairly significant in a late scene with Ophelia."
    m 1ekc "At that point in the play, she's driven insane by grief and her words don't make much sense."
    m 7eub "But she can communicate what she's feeling and what she knows through the choices of flowers that she hands to other characters."
    m 7eua "So it's not just the flower itself, but {i}who{/i} she gives which flower to."
    ...
    m 1ekc "The only thing that's clear from what she puts into words is that the whatever meaning the rue has... {i}isn't{/i} the same for both of them."
    m 1esd "Because rue is bitter and smells unpleasant, it can symbolize regret, disdain, sorrow, or distress."
    m 1euc "However... rue was also used to sprinkle holy water, so it {i}could{/i} associated with repentance too."
    m 7esd "Does Ophelia intend to mean that the queen should regret what she's done and that she should and can repent?"
    m 7euc "Does it mean that she disdains the queen {w=0.8}or does it mean she wants to commiserate with her?"
    ...
    m 7eub "Anyway,{w=0.3} I hope you don't {w=0.3}{nw}"
    extend 7nub "rue the day{w=0.6} that you learned about floriography."
    m 7hub "Ehehe~"
    return
