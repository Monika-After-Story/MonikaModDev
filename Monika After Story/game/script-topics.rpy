...
label monika_antilibrary:
    ...
    m "For example, you might buy nonfiction books that you don't intend to read right away, but you could reference for an academic paper later."
    ...
    m 3lud "You know, when I really think about it, isn't the internet also kind of like a gigantic antilibrary?"
    ...
    m 3eksdla "I think it's important that, at least before sharing it, we should be thorough in our own research."
    m 1wud "That said...{w=0.3}Oh! {w=0.1}You might even have your own digital antilibrary of bookmarks, ahaha~"
    m 1eub "I've even heard some people have a collection of games they haven't played. {w-0.2}A whole library to entertain themselves with!"
    m 1hub "Whether they're for research or fun, it might be a good idea to take a long look at that stash, huh?"
    m "You might just find a lot of hidden treasure in your antilibrary!"
    return
