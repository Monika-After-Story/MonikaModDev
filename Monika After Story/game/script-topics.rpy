...
monika_omamori
    ...
    m 1o "I've always wondered what they put inside these things."
    m 1a "Apparently, it's simply the name of the deity from the shrine, with a little something special done to it."
