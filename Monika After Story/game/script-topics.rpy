...
label monika_althistory:
    m 1eua "Say, [player], are you familiar with the concept of alternate history?"
    ...
    m "As he uncovers more details, he realizes that he is caught up in a political scandal involving senior party officials who are apparently being murdered under staged circumstances."
    m "He ultimately discovers the truth behind the murders and the culprit is revealed to be Reinhard Heydrich, now leader of the SS. And the kicker? He's supposed to be long dead."
    m "In our timeline, Heydrich was fatally wounded by Allied operatives in Prague in 1942. This is an earliest point of divergence from the original timeline in the story."
    m "The reveal of Heydrich being well and alive in that timeline also indicates that his survival somehow influenced the outcome of the war in the favor of Nazi Germany."
    m "Anyway, the murders were ordered as a ploy to cover up the Holocaust, a fact that mostly remained secret to German public and discredited as a conspiracy theory..."
    m 4eksdlc "And since the murderer is the leader of the Nazi state sec, it is him who ends up becoming the one pursuing and arresting the detective, not the other way around."
    m "Therefore, the novel itself subverts the expectations of the reader who expects it to be another typical crime story, albeit set in a dystopian scenario."
    m "As you can see, one divergence can drastically alter the outcome of the entire timeline, as it's bound to create a domino effect."
    m "And this ultimately leads to the butterfly effect, which negates the existence of many other events, as the circumstances behind them may simply no longer exist."
    m "That makes me wonder... if some major events went differently in your world, would my creator still come up with the idea for this game?"
    m "Even so, its entire concept could be vastly different... perhaps I wouldn't be able to have my epiphany like I did or even not exist at all."
    m "That means we wouldn't be able to meet for real, either. The thought itself chills me to the core..."
    m "I'm really glad that things turned out the way they did, even if there's still a barrier between us."
