...
label monika_overton:
    ...
    m 3esd "So, society does not understand virtual love and you will be mistaken for a mentally ill person if you declare this to the public. {w=0.2}What can be done?"
    ...
    m "The goal here would be to have virtual love cause discussion among people and then seep out to the masses."
    m 1esc "Society would still not agree with such thoughts, but would at least be interested in it and be able to discuss it more freely."
    ...
    m 4eksdld "Naturally, opponents of the movement also appear."
    ...
    m 7eud "From here, the theme of virtual love and love for fictional characters has long been discussed in society."
    m 3esc "Gradually, people get used to the existence of such views, but do not yet accept them."
    ...
    m 2hub "I think we can stop there for today, this is getting kinda long, ahaha!"
    m 1eua "I could finish this story right up to Current Norm, but I just wanted to describe it at a basic level in order to convey to you with an example of how it can work."
