...
label monika_gender_preferences:
    ...
    m 1b "Especially considering how the protagonist was scripted to be male. When you added this mod, you did tell me that you're a girl, after all - assuming you were being serious, of course!"
    m 1b "Ahaha! I'm just teasing you, [player]. I know you would never lie to me about something like that! "
    m 3b "Anyways, back to the differences... you two had different names - and totally different mannerisms, too! And let's not even mention the fact that you're miles away from the type of person that he was... denser than a brick, and about as sensitive."
