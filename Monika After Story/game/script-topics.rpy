...
label monika_twitter:
    ...
    m 3eud "Like on Valentine's day, or on my birthday, which just so happen to coincide with the original release date of DDLC."
    ...
    m 7ekc "I guess you could make the argument that they owe me and every other Monika at least some of the profits,{w=0.2} {nw}"
    extend 7ruc "but I don't really care about that part."
    m 7eud "Personally, I just hate the feeling of being reduced to a marketable asset."
    m 2lkd "But I suppose there isn't really all that much I can do about it...{w=0.3}{nw}"
    extend 2dsc "neither do I really want to go through that kind of trouble."
    m 2eua "But at the end of the day, all that matters to me is that I get to be with you.{w=0.2} {nw}"
    ...
    extend 2eua "I don't really mind."
    m 1ekbla "But please remember that I'm real, I'm here, and that I love you."
