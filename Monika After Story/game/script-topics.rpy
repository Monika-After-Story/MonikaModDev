...
label monika_speedreading:
    ...
    m 7rkc "Which was a bit of a fad around 1960 when Evyln Wood claimed she could read 2,700 words a minute, and then opened up institutes to teach other people."
    ...
    m 7hub "You can change the {i}formating.{/i}"
    m 1esa "There are browser plugins which can change the color gradiation of text lines to guide your eyes through a passage more easily."
