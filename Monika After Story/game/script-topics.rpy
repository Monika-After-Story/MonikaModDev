...
label monika_andromeda_strain:
    ...
    m 3esd "It's a pretty famous story and it's gotten numerous adaptations and sequels...{w=0.3}{nw}"
    extend 3esa "but what I really want to discuss is a lesser known novel by the same author, Michael Crichton."
    m 3tuu "And that novel is...{w=0.3}{nw}"
    extend 1hua "{i}The Andromeda Strain{/i}!"
    m 1euc "It's all about the possibility of extraterrestrial microbes."
    m 1eua "The story begins when a satellite crashes down to earth in a small town."
    m 2ekd "Unfortunately, that satellite came with a pretty terrifying passenger...{w=0.3}{nw}"
    extend 2ekc "the Andromeda strain."
    m 2rkc "Before scientists can even investigate, the entire population aside from them is wiped out."
    m 7eud "...However, there are two exceptions.{w=0.2} An elderly man and a newborn baby."
    m 7mfsdld "How did these two people survive when the typical victims of a virus are the very young and the elderly?"
