...
label monika_architecture:
    m 1esa "Hey, [player]...{w=0.2} I think there's this one major art branch that we've been neglecting in our talks..."
    m 3eub "Architecture!"
    m 3esa "I've been reading a bit about it lately and I find it quite interesting."
    m 1eua "...Come to think of it, architecture is one of the most common forms of art in everyday life."
    m 1eka "I'm just fascinated by how humanity tends to turn every craft into an art,{w=0.2}{nw}" 
    extend 1eua "and I think architecture is the greatest example of that."
    m 1eub "Architecture can also tell you a lot about the culture of the area it is located in...{w-0.2}different monuments, statues, historical buildings, towers..."
    m 1eua "I think that makes it even more exciting to explore the place you're visiting."
    m 1rka "It's also important to place the buildings in the most convenient way for people to use, which can be a tough task to deal with in its own right."
    m 3eud "...But that's more urban planning than actual architecture."
    m 1euc "If you prefer viewing architecture purely from the art perspective, some modern tendencies may disappoint you."
    m 1ruc "Modern architecture focuses more on getting things done in the most practical way."
    m 1euc "In my opinion, that can be both good and bad for many different reasons." 
    m 3euc "Still, I believe the most important part is to keep things balanced."
    ...
    m 1ruc "Moreover, residential areas with poorly-made buildings can lead to people not taking care of their properties and, over time, end up as downtrodden areas that are undesirable to live."
    m 1eka "It was once said that the ugliness of the outside world causes ugliness on the inside...{w=0.2}{nw}" 
    extend 3esa "which I can probably agree with."

    if mas_isMoniAff(higher=True):
        m 1euc "Yet, judging by {i}your{/i} personality... {w=0.5}{nw}"
    ...
    if persistent._mas_pm_likes_travelling:
        ...
        m 3eka "Even at the very edge of the world...{w=0.2}I'll still love you, [player]."
        m 3dka "...And I always will~"
        ...
        m 1eka "I love you, [player]. {w=0.3}Always remember that."
