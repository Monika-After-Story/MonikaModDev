...
label monika_aliens:
    ...
    m 3eua "...Though I can see why you would be interested in knowing about my opinion on it."
    ...
    m 1esc "But to answer your question..."
    m 3eua "I do believe, or at least want to believe, that there has to be {i}something{/i} out there."
    ...
    m 3esa "There are 8 planets in the solar system alone...{w=0.3}{nw}"
    extend 4eub "but of course, there are many more star systems, each with their own planets within them."
    m 4wud "Now, consider the fact that our Milky Way galaxy alone contains hundreds of billions of stars...that's a lot of potential!"
    ...
    m 2euc "Perhaps they're too far away for us to find them or maybe they just don't have the technology to receive and answer our messages for now."
    m 2etd "Or vice versa, maybe {i}we're{/i} the ones who don't have the technology to communicate with them."
    m 2etc "Or maybe they simply don't want to initiate contact with us?"
