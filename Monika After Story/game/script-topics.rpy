...
label monika_fastfood:
    ...
    m 1h "[player], do you have fast food often?"
        "Yes, I do.":
            m 1k "[player], it's ok to have it every once in a while."
            m "Yet I can't help but worry if you're eating such awful things."
            m 1j "If I were there I would cook much healthier things for you."
            m 1j "Even though I can't cook very well yet..."
            m 1j "Well, having my love in it would make it tastier than any fast food!"
            m 1j "[player], would you do something for me?"
            m 1j "Would you try to eat better? Please?"
            m 1j "I would hate it if you became sick because of your lifestyle."
            m 1j "I know it's easier to order out and preparing your own food can be a hassle..."
            m 1j "But maybe you could see cooking as an opportunity to have fun?"
            m 1j "Or perhaps a skill for you to become really good at?"
            m 1j "I would love to try your dishes, maybe do it for a date?."
            m 1j "That would be really romantic..."
            m 1j "And that way we can both enjoy ourselves and you would be eating better."
            m 1j "That's what I can a win-win!"

        "No, I don't":
            m 1a "That's a relief."
            m 1b "Sometimes you really worry me, [player]."
            m 1b "I suppose instead of eating out, you make your own food?"
            m 1b "Fast food can be really expensive over time, so doing it yourself is usually cheaper."
            m 1b "It also tastes a lot better!"
            m 1b "I know people find cooking overwhelming..."
            m 1b "If only because managing to keep enough ingredients is really inconvenient..."
            m 1b "But I think I think the results are worth the effort."
            m 1b "Are you any good at cooking [player]?"
            m 1b "It doesn't matter if you're not, I would have anything you prepared for me!"
            m 1b "Well, as long as it's vegetarian. Ehehe~"
            return
