...
label monika_althistory:
    ...
    m 1eua "All of these works are characterized with three common elements..."
    m 3eua "The first element: the background history is the same as the real world."
    m 3eub "The second: there is a change in a critical point of history, which is commonly referred as the '{i}Point of Divergence{/i}', or PoD for short."
