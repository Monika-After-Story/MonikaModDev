...
label monika_pleasure:
    ...
    m "I know that's a private topic in your world, but it's not really a concept here, so I'm curious..."
    ...
    m 1l "And maybe I'm just being a little jealous~"
    m 1m "So I guess I can let it slide... for now~"
    m 1k "And if it helps you save yourself for me, then that's a plus! Ahaha~"
