...
label monika_antilibrary:
    ...
    m "Though, personally, I think an important factor is that those unread books don't become completely disorganized."
    m 3eka "Having a bunch of stray books hiding around your house is nice, but if you want to use them well, they need some sort of structure."
