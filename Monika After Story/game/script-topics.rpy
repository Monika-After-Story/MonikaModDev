...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_Reality_parallel",category=['you','ddlc'],prompt="Reality Parallels",random=True))    
    
label monika_Reality_parallels:
    ...
    m 1d "The only difference is the tropes common in anime and visual novels, that you wouldn't find in real life."
