...
label monika_elegy_xi:
    ...
    m 3eud "This expression it's from the poem {i}'Elegy XI'{/i}, wrote by Ovid."
    m 3eua "He was a roman poet, and is best known for the book {i}'Metamorphoses'.{/i}"
    m 2rkd "He wrote {i}'Elegy XI'{/i} after the suffering imposed on him by his wife, who cheated on him many times."
