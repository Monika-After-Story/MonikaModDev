...
label monika_eating_meat:
    ...
    m 4eud "Vegan diets can be quite deficient in nutrients, such as vitamin B12, calcium, iron, and zinc. {w=0.2}Granted, there are still some options including supplements, but balancing a vegan diet takes a lot of care and thought."
    m 7eka "...So for that reason, I'm not personally against eating things like milk and eggs. {w=0.2}But I think I'd prefer to buy locally when possible."
