...
label monika_shipping:
    ...
    m 1eb  "You know, it's one of those things you've always done subconsciously, but once you learn about it, you see it everywhere!"
    ...
    m 1rsusdr "Like, usually they put Natsuki and Yuri together. They fight like cats and dogs!"
    ...
    m 1hksdra "Don't get jealous! I'm just telling you what I saw!"
    m 2rksdra "..."
    m 2rksdrb "Well, from a writer's perspective, I guess I can see it."
    m 1eud "We started the club together."
    if persistent.monika_kill:
        m "And she almost had the same epiphany I did…"
    m 2rksdrb "But...I still don't really get it. I mean, I love you, and only you!"
