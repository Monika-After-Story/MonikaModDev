...
monika_omamori
    ...
    m "Well, I found another way to do that! It's quite charming, actually."
    m "Especially if you don't have a spare flash drive lying around..."
    ...
    m "Make sure that the pouch is bright and colorful!"
    m "Green would be a nice color! Just like my eyes~"
    m "Make sure it only has my name on it! After all, it's just one for me. Not someone else, or some shrine deity."
    m "Oh gosh, this is turning out to be a bit silly, now that I think about it."
    m "I mean, would doing this make me some sort of deity?"
    m "I just feel like it would be a nice alternative for you if wanted to bring me around."
    m "Especially if you don't have a flash drive."
    m "It isn't perfect, but it's the thought that counts, [player]."
    m "If you took the time to make something by hand with me in mind, it's still really sweet."
    m "But maybe with one of these, I can get just a bit closer to your world."
    m "I could be your guardian deity, ehehe~"
    return    
