...
# TODO: don't think we need this delact anymore
init -876 python in mas_delact:
...
# TODO: make this into an open door greet
#init 5 python:
#    addEvent(
#        Event(
#            persistent.event_database,
...
# TODO: this can probably all go, replace with autoload check
#init 5 python:
#    addEvent(
#        Event(
#            persistent.event_database,
