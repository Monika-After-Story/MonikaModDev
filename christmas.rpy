...
label monika_whatiwant
    ...
    m 5b "Here goes."
    m 1r "..."
    m 4a "You are the happy to my holiday."
    m 4b "The jingle in my bells."
    m 4l "The nut to my cracker."
    m 4a "You are the fruit to my cake."
    m 4j "The present under my tree."
    m 4b "The wish to my star."
    m 4a "The candy to my cane."
    m 4m "The holly to my jolly."
    m 4a "You are the winter to my wonderland."
    m 4b "The ginger to my bread."
    m 4j "Milk to my cookie."
    m 4f "The joy to my world."
    m 4g "The star atop my tree."
    m 1p "And the love of my life."
    m 1r "..."
    m 3e "I hope you liked it, sweetheart."
    m "It's not the best gift, but it's something."
    m 3b "Don't worry about getting me anything."
    m 3a "After all, I have you. And that's all I need."
